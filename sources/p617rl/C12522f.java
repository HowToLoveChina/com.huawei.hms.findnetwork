...
public class C12522f extends AbstractC11478a<RestoreSequence> {
    public C12522f() {
    ...
    /* renamed from: c */
    public List<String> m75318c() {
        ArrayList arrayList = new ArrayList();
        try {
            Cursor cursorRawQuery = rawQuery("select appId from app_restore_thread_sequence order by CAST(sequence AS INTEGER);", null);
            ...
            C11839m.m70687e("AppRestoreSequenceThreadOperator", "getRestoreThreadSequence error: " + e10.toString());
        }
        return arrayList;
    }
    ...
    public void clear() {
        try {
            ...
            C11839m.m70687e("AppRestoreSequenceThreadOperator", "execSQL clear error: " + e10.toString());
        }
    }

    /* renamed from: d */
    public void m75319d(List<RestoreSequence> list) throws C9721b {
        if (list == null) {
            C11839m.m70687e("AppRestoreSequenceThreadOperator", "updateRestoreThreadSequence error: restoreSequenceList is null");
            return;
        }
        ArrayList arrayList = new ArrayList();
        ...
        try {
            ...
            C11839m.m70687e("AppRestoreSequenceThreadOperator", "updateRestoreThreadSequence error: " + e10.toString());
            throw new C9721b(FamilyShareConstants.StatusCode.SPACE_SHARE_NOT_OPEN, "update restore thread sequence exec error. " + e10.getMessage(), "execSQL");
        }
    }
}
