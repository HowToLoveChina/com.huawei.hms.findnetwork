...
public class C13827h extends NoticeCfgLanguageBaseManager {
    ...
    public void clearCurrentLanguageDownloadResult() {
        C10028c.m62182c0().m62353l("campaign_quest_language_download_result");
    }

    @Override // com.huawei.hicloud.notification.manager.NoticeCfgLanguageBaseManager
    public void clearLangVersionAndResult() {
        NotifyLogger.m29915i("TaskLanguageManager", "clear notice language");
        C10028c.m62182c0().m62353l("campaign_quest_language_version");
        C10028c.m62182c0().m62353l("campaign_quest_language_download_result");
    }

    @Override // com.huawei.hicloud.notification.manager.NoticeCfgLanguageBaseManager
    public void clearLanguageDb() throws SQLException {
        NotifyLogger.m29915i("TaskLanguageManager", "clearLanguageDb");
    ...
    public boolean databaseHasRecord() {
        try {
            ...
            NotifyLogger.m29914e("TaskLanguageManager", "databaseHasRecord exceptions:" + e10.toString());
            return false;
        }
    }
    ...
    public String getCurrentLanguageHash() {
        return C10028c.m62182c0().m62184A("campaign_quest_language_hash");
    }

    @Override // com.huawei.hicloud.notification.manager.NoticeCfgLanguageBaseManager
    public int getCurrentLanguageVersion() {
        return C10028c.m62182c0().m62189B("campaign_quest_language_version");
    }

    @Override // com.huawei.hicloud.notification.manager.NoticeCfgLanguageBaseManager
    public boolean getExtractResult() {
        return C10028c.m62182c0().m62324f0("campaign_quest_language_download_result");
    }

    @Override // com.huawei.hicloud.notification.manager.NoticeCfgLanguageBaseManager
    public String getLanguageFilePath() {
        return C0213f.m1378b().getFilesDir() + File.separator + "campaign_quest_language.json";
    }
    ...
    public void insertLanguageToDB(ArrayList<CommonLanguageDbString> arrayList) {
        try {
            ...
            NotifyLogger.m29914e("TaskLanguageManager", str);
    ...
    public void setCurrentLanguageHash(String str) {
        C10028c.m62182c0().m62381q2("campaign_quest_language_hash", str);
    }

    @Override // com.huawei.hicloud.notification.manager.NoticeCfgLanguageBaseManager
    public void setCurrentLanguageVersion(int i10) {
        C10028c.m62182c0().m62386r2("campaign_quest_language_version", i10);
    }

    @Override // com.huawei.hicloud.notification.manager.NoticeCfgLanguageBaseManager
    public void setExtractResult(boolean z10) {
        C10028c.m62182c0().m62281U2("campaign_quest_language_download_result", z10);
    }
}
