...
public class C13642a implements InterfaceC12231a<InterfaceC12043j, boolean[]> {
    ...
    public void mo73425c(String str, InterfaceC12043j interfaceC12043j) throws C10626e {
        ...
        this.f61338b = interfaceC12043j.min();
        this.f61339c = interfaceC12043j.max();
        this.f61337a = C11533f.m68827e(interfaceC12043j, str);
    }

    @Override // p559pv.InterfaceC12231a
    /* renamed from: e, reason: merged with bridge method [inline-methods] */
    public boolean mo73424b(boolean[] zArr) {
        if (zArr == null) {
            return true;
        }
        int length = zArr.length;
        return length >= this.f61338b && length <= this.f61339c;
    }
}
