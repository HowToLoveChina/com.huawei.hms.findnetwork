...
public class FeedbackWebConstants {
    ...
    public static final String DELETE_HISTORY_URL = "hwc/batchDeleteProblem";
    ...
    public static String getLogPath(Context context) throws IOException {
        ...
        String sdk = FaqSdk.getSdk().getSdk(FaqConstants.FAQ_LOG_ROOT_PATH);
        return !TextUtils.isEmpty(sdk) ? sdk : (!"Y".equalsIgnoreCase(FaqSdk.getSdk().getSdk(FaqConstants.FAQ_LOG_SERVER_LOG_SDCARD)) || (externalFilesDir = context.getExternalFilesDir("")) == null) ? context.getFilesDir().getAbsolutePath() : externalFilesDir.getCanonicalPath();
    }
