...
public class C8781c {
    ...
    /* renamed from: a */
    private static final Map<String, String> f45075a;
    ...
    static {
        ...
        map.put("android.hardware.faketouch", CloudBackupConstant.UserPackageInfo.ONE_T_MEMBER);
        ...
        map.put("android.hardware.microphone", CloudBackupConstant.UserPackageInfo.GOLD_MEMBER);
        ...
        map.put("android.hardware.sensor.gyroscope", CloudBackupConstant.UserPackageInfo.SILVER_MEMBER);
        map.put("android.hardware.sensor.light", CloudBackupConstant.UserPackageInfo.TRIAL_MEMBER);
        ...
        map.put("android.hardware.touchscreen", VideoPlayFlag.PLAY_IN_ALL);
        ...
        map.put("android.software.home_screen", Constants.MULTIPLE_SIGN);
        ...
        map.put("com.hihonor.software.features.handset", DownloadTaskBaseCallable.DOWNLOAD_POOL_SHUTDOWN);
    ...
    /* renamed from: a */
    public static String m56037a(String str) {
        Map<String, String> map = f45075a;
