...
public class ApkUpgradeInfo extends AbstractC8799b implements Serializable, Parcelable {
    public static final int APP_MUST_UPDATE = 1;
    public static final Parcelable.Creator<ApkUpgradeInfo> CREATOR = new C8841a();
    ...
    public static class C8841a implements Parcelable.Creator<ApkUpgradeInfo> {
    ...
    public void setBundleSize_(long j10) {
        this.bundleSize_ = j10;
    }
    ...
    public void setDevType_(int i10) {
        this.devType_ = i10;
    }
    ...
    public void setDiffSize_(int i10) {
        this.diffSize_ = i10;
    }
    ...
    public void setIsAutoUpdate_(int i10) {
        this.isAutoUpdate_ = i10;
    }

    public void setIsCompulsoryUpdate_(int i10) {
        this.isCompulsoryUpdate_ = i10;
    }

    public void setMaple_(int i10) {
        this.maple_ = i10;
    }
    ...
    public void setObbSize_(long j10) {
        this.obbSize_ = j10;
    }

    public void setOldVersionCode_(int i10) {
        this.oldVersionCode_ = i10;
    }
    ...
    public void setPackingType_(int i10) {
        this.packingType_ = i10;
    }
    ...
    public void setState_(int i10) {
        this.state_ = i10;
    }

    public void setVersionCode_(int i10) {
