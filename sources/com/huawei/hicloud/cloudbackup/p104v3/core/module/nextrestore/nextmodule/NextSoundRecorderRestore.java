...
public class NextSoundRecorderRestore extends NextModuleRestore {
    public NextSoundRecorderRestore(Context context, C4880b c4880b, CloudRestoreStatusV3 cloudRestoreStatusV3) {
    ...
    public String getApkModuleName() {
        return NextRestoreConstants.PKG_NAME_SOUND_RECORDER;
    }

    @Override // com.huawei.hicloud.cloudbackup.p104v3.core.module.nextrestore.nextmodule.NextModuleRestore
    public String getBackupProviderUri() {
        return "content://com.huawei.soundrecorder.backupProvider";
    }
}
