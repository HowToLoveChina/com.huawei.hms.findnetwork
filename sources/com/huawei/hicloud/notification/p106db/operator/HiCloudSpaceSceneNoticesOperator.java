...
import com.huawei.hicloud.notification.p106db.script.SceneNoticesLanguageScript;
import fk.C9721b;
...
public class HiCloudSpaceSceneNoticesOperator extends AbstractC0315c<CommonLanguageDbString> {
    ...
    public String queryContent(String str, String str2) throws Throwable {
        ...
        try {
            listQueryResult4Vo = queryResult4Vo(SceneNoticesLanguageScript.QUERY_VALUE, new String[]{str, str2});
        } catch (C9721b e10) {
