...
import com.huawei.hicloud.notification.p106db.script.HiCloudBrandHomePageBannerScript;
import fk.C9721b;
...
public class HiCloudBrandHomePageBannerOperator extends AbstractC0315c<CommonLanguageDbString> {
    private static final String TAG = "HiCloudBrandHomePageBannerOperator";
    ...
    public void batchInsert(ArrayList<CommonLanguageDbString> arrayList) throws C9721b {
        ...
        execSQL4Batch(HiCloudBrandHomePageBannerScript.INSERT_STRING, arrayList2);
    }

    public void clear() {
        NotifyLogger.m29913d(TAG, "clear");
        try {
            execSQL(HiCloudBrandHomePageBannerScript.CLEAR);
        } catch (C9721b e10) {
    ...
    public boolean hasRecord() {
        ...
        try {
            return queryCount(HiCloudBrandHomePageBannerScript.QUERY_COUNT) > 0;
        } catch (C9721b e10) {
            NotifyLogger.m29914e(TAG, "hasRecord fail: " + e10.toString());
            return false;
        }
    }
    ...
    public List<CommonLanguageDbString> queryString(String str, String str2, String str3, String str4) {
        ...
        try {
            return queryResult4Vo(HiCloudBrandHomePageBannerScript.SQL_QUERY_STRING_VALUE, new String[]{str, str2 + '%', str3, str4});
        } catch (Exception e10) {
