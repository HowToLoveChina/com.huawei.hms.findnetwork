...
import com.huawei.hicloud.notification.p106db.script.DriveConfigLanguageScript;
import fk.C9721b;
...
public class DriveConfigLanguageOperator extends AbstractC0315c<SyncConfigString> {
    private static final String TAG = "DriveConfigLanguageOperator";
    ...
    public void batchInsert(ArrayList<SyncConfigString> arrayList) throws Exception {
        ...
        execSQL4Batch(DriveConfigLanguageScript.SQL_INSERT, arrayList2);
    }

    public void clear() {
        NotifyLogger.m29913d(TAG, "clear ");
        try {
            execSQL(DriveConfigLanguageScript.CLEAR);
        } catch (Exception e10) {
    ...
    public boolean hasRecord() {
        try {
            return queryCount(DriveConfigLanguageScript.GET_COUNT) > 0;
        } catch (C9721b e10) {
    ...
    public List<SyncConfigString> queryString(String str, String str2, String str3, String str4) {
        ...
        try {
            return queryResult4Vo(DriveConfigLanguageScript.SQL_QUERY_STRING_VALUE, new String[]{str, str2 + '%', str3, str4});
        } catch (Exception e10) {
