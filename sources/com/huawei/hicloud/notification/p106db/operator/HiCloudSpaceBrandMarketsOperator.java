...
import com.huawei.hicloud.notification.p106db.script.BrandMarketsLanguageScript;
import fk.C9721b;
...
public class HiCloudSpaceBrandMarketsOperator extends AbstractC0315c<CommonLanguageDbString> {
    private static final String TAG = "HiCloudSpaceBrandMarketsOperator";
    ...
    public void batchInsert(ArrayList<CommonLanguageDbString> arrayList) throws C9721b {
        ...
        execSQL4Batch(BrandMarketsLanguageScript.INSERT_STRING, arrayList2);
    }

    public void clear() throws SQLException {
        NotifyLogger.m29913d(TAG, "clear");
        try {
            execSQL(BrandMarketsLanguageScript.CLEAR);
        } catch (C9721b e10) {
    ...
    public boolean hasRecord() {
        ...
        try {
            return queryCount(BrandMarketsLanguageScript.QUERY_COUNT) > 0;
        } catch (C9721b e10) {
    ...
    public String queryContent(String str, String str2) throws Throwable {
        ...
        try {
            listQueryResult4Vo = queryResult4Vo(BrandMarketsLanguageScript.QUERY_VALUE, new String[]{str, str2});
        } catch (C9721b e10) {
    ...
    public List<CommonLanguageDbString> queryString(String str, String str2, String str3, String str4) {
        ...
        try {
            return queryResult4Vo(BrandMarketsLanguageScript.SQL_QUERY_STRING_VALUE, new String[]{str, str2 + '%', str3, str4});
        } catch (Exception e10) {
            NotifyLogger.m29914e(TAG, e10.toString());
            return null;
        }
