...
import com.huawei.hicloud.notification.p106db.script.NoticeContentLanguageScript;
import fk.C9721b;
...
public class NoticeContentLanguageOperator extends AbstractC0315c<CommonLanguageDbString> {
    private static final String TAG = "NoticeContentLanguageOperator";
    ...
    public void batchInsert(ArrayList<CommonLanguageDbString> arrayList) throws C9721b {
        ...
        execSQL4Batch(NoticeContentLanguageScript.INSERT_STRING, arrayList2);
    ...
    public void clear() throws SQLException {
        ...
        try {
            execSQL(NoticeContentLanguageScript.CLEAR);
        } catch (C9721b e10) {
    ...
    public boolean hasRecord() {
        try {
            return queryCount(NoticeContentLanguageScript.GET_COUNT) > 0;
        } catch (C9721b e10) {
    ...
    public List<CommonLanguageDbString> queryAllString(String str, String str2, String str3) {
        ...
        try {
            return queryResult4Vo(NoticeContentLanguageScript.SQL_QUERY_ALL_STRING_VALUE, new String[]{str, str2 + '%', str3});
        } catch (Exception e10) {
    ...
    public String queryContent(String str, String str2) throws Throwable {
        ...
        try {
            listQueryResult4Vo = queryResult4Vo(NoticeContentLanguageScript.QUERY_VALUE, new String[]{str, str2});
        } catch (C9721b e10) {
    ...
    public List<CommonLanguageDbString> queryString(String str, String str2, String str3, String str4) {
        NotifyLogger.m29913d(TAG, "queryString");
        try {
            return queryResult4Vo(NoticeContentLanguageScript.SQL_QUERY_STRING_VALUE, new String[]{str, str2 + '%', str3, str4});
        } catch (Exception e10) {
            NotifyLogger.m29914e(TAG, e10.toString());
            return null;
        }
