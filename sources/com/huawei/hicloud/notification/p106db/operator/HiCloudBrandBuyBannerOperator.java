...
import com.huawei.hicloud.notification.p106db.script.HiCloudBrandBuyBannerScript;
import fk.C9721b;
...
public class HiCloudBrandBuyBannerOperator extends AbstractC0315c<CommonLanguageDbString> {
    private static final String TAG = "HiCloudBrandBuyBannerOperator";
    ...
    public void batchInsert(ArrayList<CommonLanguageDbString> arrayList) throws C9721b {
        ...
        execSQL4Batch(HiCloudBrandBuyBannerScript.INSERT_STRING, arrayList2);
    }

    public void clear() {
        NotifyLogger.m29913d(TAG, "clear");
        try {
            execSQL(HiCloudBrandBuyBannerScript.CLEAR);
        } catch (C9721b e10) {
    ...
    public boolean hasRecord() {
        ...
        try {
            return queryCount(HiCloudBrandBuyBannerScript.QUERY_COUNT) > 0;
        } catch (C9721b e10) {
    ...
    public List<CommonLanguageDbString> queryString(String str, String str2, String str3, String str4) {
        ...
        try {
            return queryResult4Vo(HiCloudBrandBuyBannerScript.SQL_QUERY_STRING_VALUE, new String[]{str, str2 + '%', str3, str4});
        } catch (Exception e10) {
            NotifyLogger.m29914e(TAG, e10.toString());
            return null;
        }
