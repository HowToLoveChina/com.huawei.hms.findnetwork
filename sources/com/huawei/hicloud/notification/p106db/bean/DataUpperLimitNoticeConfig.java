...
public class DataUpperLimitNoticeConfig {
    ...
    private List<DataUpperLimitNotice> configuration;
    ...
    public List<DataUpperLimitNotice> getConfiguration() {
    ...
    public void setConfiguration(List<DataUpperLimitNotice> list) {
