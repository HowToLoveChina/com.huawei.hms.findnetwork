...
import com.huawei.hicloud.notification.p106db.script.SpaceNoticeV3LanguageScript;
import fk.C9721b;
...
public class SpaceNoticeV3LocalLanguageOperator extends AbstractC0315c<CommonLanguageDbString> {
    ...
    public void batchInsert(ArrayList<CommonLanguageDbString> arrayList) throws C9721b {
        ...
        execSQL4Batch(SpaceNoticeV3LanguageScript.INSERT_STRING_LOCAL, arrayList2);
    ...
    public void clear() throws SQLException {
        ...
        try {
            execSQL(SpaceNoticeV3LanguageScript.CLEAR_LOCAL);
        } catch (C9721b e10) {
    ...
    public boolean hasRecord() {
        try {
            return queryCount(SpaceNoticeV3LanguageScript.GET_COUNT_LOCAL) > 0;
        } catch (C9721b e10) {
    ...
    public List<CommonLanguageDbString> queryAllString(String str, String str2, String str3) {
        ...
        try {
            return queryResult4Vo(SpaceNoticeV3LanguageScript.SQL_QUERY_ALL_STRING_VALUE_LOCAL, new String[]{str, str2 + '%', str3});
        } catch (Exception e10) {
    ...
    public String queryContent(String str, String str2) throws Throwable {
        ...
        try {
            listQueryResult4Vo = queryResult4Vo(SpaceNoticeV3LanguageScript.QUERY_VALUE_LOCAL, new String[]{str, str2});
        } catch (C9721b e10) {
    ...
    public List<CommonLanguageDbString> queryString(String str, String str2, String str3, String str4) {
        ...
        try {
            return queryResult4Vo(SpaceNoticeV3LanguageScript.SQL_QUERY_STRING_VALUE_LOCAL, new String[]{str, str2 + '%', str3, str4});
        } catch (Exception e10) {
