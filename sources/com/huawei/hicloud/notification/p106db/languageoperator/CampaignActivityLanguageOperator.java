...
public class CampaignActivityLanguageOperator extends AbstractC0315c<CommonLanguageDbString> {
    private static final String TAG = "CampaignActivityLanguageOperator";
    ...
    public void batchInsert(ArrayList<CommonLanguageDbString> arrayList) throws C9721b {
        ...
        execSQL4Batch("insert into campaign_activity_language values(?, ?, ?);", arrayList2);
    ...
    public void clear() throws SQLException {
        ...
        try {
            execSQL("delete from campaign_activity_language;");
        } catch (C9721b e10) {
    ...
    public boolean hasRecord() {
        try {
            return queryCount("select count(*) from campaign_activity_language;") > 0;
        } catch (C9721b e10) {
    ...
    public List<CommonLanguageDbString> queryAllStringByName(String str) {
        NotifyLogger.m29913d(TAG, "queryAllStringByName");
        try {
            return queryResult4Vo("select languageName, textName, textValue from campaign_activity_language where textName = ?;", new String[]{str});
        } catch (Exception e10) {
            NotifyLogger.m29914e(TAG, e10.getMessage());
    ...
    public String queryContent(String str, String str2) throws Throwable {
        ...
        try {
            listQueryResult4Vo = queryResult4Vo("select languageName, textName, textValue from campaign_activity_language where languageName = ? and textName = ?;", new String[]{str, str2});
        } catch (C9721b e10) {
    ...
    public List<CommonLanguageDbString> queryString(String str, String str2, String str3, String str4) {
        ...
        try {
            return queryResult4Vo("select languageName,textName,textValue from campaign_activity_language where (languageName=? or languageName like ? or languageName=?) and textName=?;", new String[]{str, str2 + '%', str3, str4});
        } catch (Exception e10) {
