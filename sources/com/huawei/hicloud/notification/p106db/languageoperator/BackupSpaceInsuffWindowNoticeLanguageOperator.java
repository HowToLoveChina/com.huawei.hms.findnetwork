...
import com.huawei.hicloud.notification.p106db.script.BackupSpaceV5NoticeLanguageScript;
import fk.C9721b;
...
public class BackupSpaceInsuffWindowNoticeLanguageOperator extends AbstractC0315c<CommonLanguageDbString> {
    private static final String TAG = "BackupSpaceInsuffWindowNoticeLanguageOperator";
    ...
    public void batchInsert(ArrayList<CommonLanguageDbString> arrayList) throws C9721b {
        ...
        execSQL4Batch(BackupSpaceV5NoticeLanguageScript.INSERT_STRING, arrayList2);
    ...
    public void clear() throws SQLException {
        ...
        try {
            execSQL(BackupSpaceV5NoticeLanguageScript.CLEAR);
        } catch (C9721b e10) {
    ...
    public boolean hasRecord() {
        try {
            return queryCount(BackupSpaceV5NoticeLanguageScript.GET_COUNT) > 0;
        } catch (C9721b e10) {
    ...
    public List<CommonLanguageDbString> queryAllString(String str, String str2, String str3) {
        ...
        try {
            return queryResult4Vo(BackupSpaceV5NoticeLanguageScript.SQL_QUERY_ALL_STRING_VALUE, new String[]{str, str2 + '%', str3});
        } catch (Exception e10) {
    ...
    public String queryContent(String str, String str2) throws Throwable {
        ...
        try {
            listQueryResult4Vo = queryResult4Vo(BackupSpaceV5NoticeLanguageScript.QUERY_VALUE, new String[]{str, str2});
        } catch (C9721b e10) {
    ...
    public List<CommonLanguageDbString> queryString(String str, String str2, String str3, String str4) {
        ...
        try {
            return queryResult4Vo(BackupSpaceV5NoticeLanguageScript.SQL_QUERY_STRING_VALUE, new String[]{str, str2 + '%', str3, str4});
        } catch (Exception e10) {
    ...
    public void clear(String str) throws SQLException {
        NotifyLogger.m29915i(TAG, "clear notice language db");
        try {
            execSQL(BackupSpaceV5NoticeLanguageScript.CLEAR_BY_INSTANCE_ID, new String[]{'%' + str + "/%"});
        } catch (C9721b e10) {
            NotifyLogger.m29916w(TAG, "clear fail: " + e10.getMessage());
        }
    }
