...
public class SpaceNoticeV3LanguageOperator extends AbstractC0315c<CommonLanguageDbString> {
    private static final String TAG = "SpaceNoticeV3LanguageOperator";
    ...
    public void batchInsert(ArrayList<CommonLanguageDbString> arrayList) throws C9721b {
        ...
        execSQL4Batch(SpaceNoticeV3LanguageScript.INSERT_STRING, arrayList2);
    ...
    public void clear() throws SQLException {
        ...
        try {
            execSQL(SpaceNoticeV3LanguageScript.CLEAR);
        } catch (C9721b e10) {
    ...
    public boolean hasRecord() {
        try {
            return queryCount(SpaceNoticeV3LanguageScript.GET_COUNT) > 0;
        } catch (C9721b e10) {
    ...
    public List<CommonLanguageDbString> queryAllString(String str, String str2, String str3) {
        ...
        try {
            return queryResult4Vo(SpaceNoticeV3LanguageScript.SQL_QUERY_ALL_STRING_VALUE, new String[]{str, str2 + '%', str3});
        } catch (Exception e10) {
    ...
    public String queryContent(String str, String str2) throws Throwable {
        ...
        try {
            listQueryResult4Vo = queryResult4Vo(SpaceNoticeV3LanguageScript.QUERY_VALUE, new String[]{str, str2});
        } catch (C9721b e10) {
    ...
    public List<CommonLanguageDbString> queryString(String str, String str2, String str3, String str4) {
        ...
        try {
            return queryResult4Vo(SpaceNoticeV3LanguageScript.SQL_QUERY_STRING_VALUE, new String[]{str, str2 + '%', str3, str4});
        } catch (Exception e10) {
