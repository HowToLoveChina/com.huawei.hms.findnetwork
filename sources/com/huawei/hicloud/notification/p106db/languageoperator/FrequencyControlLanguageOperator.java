...
import com.huawei.hicloud.notification.p106db.script.FrequencyControlLanguageScript;
import fk.C9721b;
...
public class FrequencyControlLanguageOperator extends AbstractC0315c<CommonLanguageDbString> {
    private static final String TAG = "FrequencyControlLanguageOperator";
    ...
    public void batchInsert(ArrayList<CommonLanguageDbString> arrayList) throws C9721b {
        ...
        execSQL4Batch(FrequencyControlLanguageScript.INSERT_STRING, arrayList2);
    ...
    public void clear() throws SQLException {
        ...
        try {
            execSQL(FrequencyControlLanguageScript.CLEAR);
        } catch (C9721b e10) {
    ...
    public boolean hasRecord() {
        try {
            return queryCount(FrequencyControlLanguageScript.GET_COUNT) > 0;
        } catch (C9721b e10) {
    ...
    public List<CommonLanguageDbString> queryAllString(String str, String str2, String str3) {
        ...
        try {
            return queryResult4Vo(FrequencyControlLanguageScript.SQL_QUERY_ALL_STRING_VALUE, new String[]{str, str2 + '%', str3});
        } catch (Exception e10) {
    ...
    public String queryContent(String str, String str2) throws Throwable {
        ...
        try {
            listQueryResult4Vo = queryResult4Vo(FrequencyControlLanguageScript.QUERY_VALUE, new String[]{str, str2});
        } catch (C9721b e10) {
    ...
    public List<CommonLanguageDbString> queryString(String str, String str2, String str3, String str4) {
        NotifyLogger.m29913d(TAG, "queryString");
        try {
            return queryResult4Vo(FrequencyControlLanguageScript.SQL_QUERY_STRING_VALUE, new String[]{str, str2 + '%', str3, str4});
        } catch (Exception e10) {
            NotifyLogger.m29914e(TAG, e10.toString());
            return null;
        }
