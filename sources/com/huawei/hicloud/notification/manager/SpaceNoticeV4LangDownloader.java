...
public class SpaceNoticeV4LangDownloader extends NoticeCfgLanguageBaseManager {
    private static final SpaceNoticeV4LangDownloader INSTANCE = new SpaceNoticeV4LangDownloader();
    private static final Object LOCK_OBJ = new Object();
    private static final String TAG = "SpaceNoticeV4LangDownloader";
    private int backupSpaceInsufficientId;
    ...
    private SpaceV4Listener spaceV4Listener = null;

    public class SpaceV4Listener implements C11984f.d {
        private SpaceV4Listener() {
        }

        @Override // p529op.C11984f.d
        public void onScreenOff() {
            NotifyLogger.m29915i(SpaceNoticeV4LangDownloader.TAG, "SpaceV4Listener:screen is off");
            SpaceNoticeV4LangDownloader.this.isScreenOn = false;
        }

        @Override // p529op.C11984f.d
        public void onScreenOn() {
            NotifyLogger.m29915i(SpaceNoticeV4LangDownloader.TAG, "SpaceV4Listener:screen is on");
            SpaceNoticeV4LangDownloader.this.isScreenOn = true;
        }
        ...
        public /* synthetic */ SpaceV4Listener(SpaceNoticeV4LangDownloader spaceNoticeV4LangDownloader, C49431 c49431) {
            this();
        }
    }

    public SpaceNoticeV4LangDownloader(int i10) {
        this.backupSpaceInsufficientId = i10;
    }

    public static SpaceNoticeV4LangDownloader getInstance() {
        return INSTANCE;
    }
    ...
    public void clearCurrentLanguageDownloadResult() {
        C10028c.m62182c0().m62353l(this.backupSpaceInsufficientId + "_space_notice_v4_download_result");
    }

    @Override // com.huawei.hicloud.notification.manager.NoticeCfgLanguageBaseManager
    public void clearLangVersionAndResult() {
        NotifyLogger.m29915i(TAG, "clear notice language");
        C10028c.m62182c0().m62353l("_space_notice_v4_version");
        C10028c.m62182c0().m62353l("_space_notice_v4_download_result");
    }

    @Override // com.huawei.hicloud.notification.manager.NoticeCfgLanguageBaseManager
    public void clearLanguageDb() throws SQLException {
        NotifyLogger.m29915i(TAG, "clearLanguageDb");
        new SpaceNoticeV4LanguageOperator().clear(this.backupSpaceInsufficientId);
    }
    ...
    public String getCurrentLanguageHash() {
        return C10028c.m62182c0().m62184A(this.backupSpaceInsufficientId + "_space_notice_v4_hash");
    }

    @Override // com.huawei.hicloud.notification.manager.NoticeCfgLanguageBaseManager
    public int getCurrentLanguageVersion() {
        return C10028c.m62182c0().m62189B(this.backupSpaceInsufficientId + "_space_notice_v4_version");
    }

    @Override // com.huawei.hicloud.notification.manager.NoticeCfgLanguageBaseManager
    public boolean getExtractResult() {
        return C10028c.m62182c0().m62324f0(this.backupSpaceInsufficientId + "_space_notice_v4_download_result");
    }

    @Override // com.huawei.hicloud.notification.manager.NoticeCfgLanguageBaseManager
    public String getLanguageFilePath() {
        return C0213f.m1377a().getFilesDir() + File.separator + this.backupSpaceInsufficientId + "_space_usage_notice_v4_language.xml";
    }

    @Override // com.huawei.hicloud.notification.manager.NoticeCfgLanguageBaseManager
    public AbstractRunnableC12516b.a getLanguageTaskEnum() {
        return AbstractRunnableC12516b.a.SPACE_V4_LANGUAGE_PARSE;
    }
    ...
    public void insertLanguageToDB(ArrayList<CommonLanguageDbString> arrayList) {
        try {
            new SpaceNoticeV4LanguageOperator().batchInsert(arrayList);
        } catch (Exception e10) {
    ...
    public void registerListener() {
        if (this.spaceV4Listener == null) {
            this.spaceV4Listener = new SpaceV4Listener();
            C11984f.m72128c().m72129b(this.spaceV4Listener);
    ...
    public void setCurrentLanguageHash(String str) {
        C10028c.m62182c0().m62381q2(this.backupSpaceInsufficientId + "_space_notice_v4_hash", str);
    }

    @Override // com.huawei.hicloud.notification.manager.NoticeCfgLanguageBaseManager
    public void setCurrentLanguageVersion(int i10) {
        C10028c.m62182c0().m62386r2(this.backupSpaceInsufficientId + "_space_notice_v4_version", i10);
    }

    @Override // com.huawei.hicloud.notification.manager.NoticeCfgLanguageBaseManager
    public void setExtractResult(boolean z10) {
        C10028c.m62182c0().m62281U2(this.backupSpaceInsufficientId + "_space_notice_v4_download_result", z10);
    }
    ...
    public void unregisterListener() {
        if (this.spaceV4Listener != null) {
            C11984f.m72128c().m72131e(this.spaceV4Listener);
            this.spaceV4Listener = null;
            NotifyLogger.m29915i(TAG, "unregisterSpaceV4Listener");
        }
    }

    public SpaceNoticeV4LangDownloader() {
    }
}
