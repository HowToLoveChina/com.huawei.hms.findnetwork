...
public class HomepageSwitchNoticeLangDownloader extends NoticeCfgLanguageBaseManager {
    ...
    public String getCurrentLanguageHash() {
        return C10028c.m62182c0().m62184A("homepage_switch_notice_language_hash");
    }

    @Override // com.huawei.hicloud.notification.manager.NoticeCfgLanguageBaseManager
    public int getCurrentLanguageVersion() {
        return C10028c.m62182c0().m62189B("homepage_switch_notice_language_version");
    }

    @Override // com.huawei.hicloud.notification.manager.NoticeCfgLanguageBaseManager
    public boolean getExtractResult() {
        return C10028c.m62182c0().m62324f0("homepage_switch_notice_language_download_result");
    }

    @Override // com.huawei.hicloud.notification.manager.NoticeCfgLanguageBaseManager
    public String getLanguageFilePath() {
        return C0213f.m1377a().getFilesDir() + File.separator + "homepage_switch_notice_language.xml";
    }
    ...
    public C11060c getStat() {
        if (this.stat == null) {
            C11060c c11060cM66626a = C11058a.m66626a(C11058a.m66627b("07064"), "07064", C13452e.m80781L().m80971t0());
    ...
    public void setCurrentLanguageHash(String str) {
        C10028c.m62182c0().m62381q2("homepage_switch_notice_language_hash", str);
    }

    @Override // com.huawei.hicloud.notification.manager.NoticeCfgLanguageBaseManager
    public void setCurrentLanguageVersion(int i10) {
        C10028c.m62182c0().m62386r2("homepage_switch_notice_language_version", i10);
    }

    @Override // com.huawei.hicloud.notification.manager.NoticeCfgLanguageBaseManager
    public void setExtractResult(boolean z10) {
        C10028c.m62182c0().m62281U2("homepage_switch_notice_language_download_result", z10);
    }
}
