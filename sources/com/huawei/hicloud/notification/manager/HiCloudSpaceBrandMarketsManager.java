...
import com.huawei.hicloud.notification.p106db.operator.HiCloudSpaceBrandMarketsOperator;
import java.io.File;
...
public class HiCloudSpaceBrandMarketsManager {
    ...
    public void clearConfigFileAndDb() throws SQLException {
        ...
        sb2.append(str);
        sb2.append(RecommendCardConstants.LanguageFileName.HICLOUD_SPACE_BRAND_MARKETS);
        recommendCardManager.clearFile(sb2.toString());
        RecommendCardManager.getInstance().clearFile(contextM1378b.getFilesDir() + str + "HiCloudSpaceBrandMarkets.json");
        new HiCloudSpaceBrandMarketsOperator().clear();
        C11327e.m68059b("HiCloudSpaceBrandMarkets");
    }
