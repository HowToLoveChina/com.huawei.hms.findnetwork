...
public class STInvalidNotificationManager {
    private static final String TAG = "STInvalidNotificationManager";
    private HNCloudConfig mCloudConfig = new HNCloudConfig();
    private HNLocalConfig mLocalConfig = new HNLocalConfig();

    public NotificationConfig getStInvalidNoticeConfig() {
