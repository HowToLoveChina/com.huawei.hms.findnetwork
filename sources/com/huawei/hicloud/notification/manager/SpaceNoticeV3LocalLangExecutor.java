...
public class SpaceNoticeV3LocalLangExecutor extends NoticeCfgLanguageBaseManager {
    ...
    public void clearCurrentLanguageDownloadResult() {
        C10028c.m62182c0().m62353l("space_notice_v3_local_result");
    }

    @Override // com.huawei.hicloud.notification.manager.NoticeCfgLanguageBaseManager
    public void clearLangVersionAndResult() {
        NotifyLogger.m29915i(TAG, "clear notice language");
        C10028c.m62182c0().m62353l("space_notice_v3_local_version");
        C10028c.m62182c0().m62353l("space_notice_v3_local_result");
    }
    ...
    public String getCurrentLanguageHash() {
        return C10028c.m62182c0().m62184A("space_notice_v3_local_hash");
    }

    @Override // com.huawei.hicloud.notification.manager.NoticeCfgLanguageBaseManager
    public int getCurrentLanguageVersion() {
        return C10028c.m62182c0().m62189B("space_notice_v3_local_version");
    }

    @Override // com.huawei.hicloud.notification.manager.NoticeCfgLanguageBaseManager
    public boolean getExtractResult() {
        return C10028c.m62182c0().m62324f0("space_notice_v3_local_result");
    }
    ...
    */
    public void parseLanguageFile(java.lang.String r10) throws java.lang.Throwable {
        ...
        L92:
            ...
            java.lang.String r1 = "spaceNoticeV3LocalLangExecutor, parse notice language xml success"
        ...
        La6:
            ...
            java.lang.String r3 = "spaceNoticeV3LocalLangExecutor, parse notice language xml error:"
    ...
    public void setCurrentLanguageHash(String str) {
        C10028c.m62182c0().m62381q2("space_notice_v3_local_hash", str);
    }

    @Override // com.huawei.hicloud.notification.manager.NoticeCfgLanguageBaseManager
    public void setCurrentLanguageVersion(int i10) {
        C10028c.m62182c0().m62386r2("space_notice_v3_local_version", i10);
    }

    @Override // com.huawei.hicloud.notification.manager.NoticeCfgLanguageBaseManager
    public void setExtractResult(boolean z10) {
        C10028c.m62182c0().m62281U2("space_notice_v3_local_result", z10);
    }
}
