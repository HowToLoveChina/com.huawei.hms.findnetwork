...
public class DataUpperLimitNoticeLangDownloader extends NoticeCfgLanguageBaseManager {
    private static final DataUpperLimitNoticeLangDownloader INSTANCE = new DataUpperLimitNoticeLangDownloader();
    private static final String TAG = "DataUpperLimitNoticeLangDownloader";

    public static DataUpperLimitNoticeLangDownloader getInstance() {
        return INSTANCE;
    }
    ...
    public boolean databaseHasRecord() {
        try {
            return new DataUpperLimitLanguageOperator().hasRecord();
        } catch (Exception e10) {
    ...
    public String getCurrentLanguageHash() {
        return C10028c.m62182c0().m62184A("data_upper_limit_language_hash");
    }

    @Override // com.huawei.hicloud.notification.manager.NoticeCfgLanguageBaseManager
    public int getCurrentLanguageVersion() {
        return C10028c.m62182c0().m62189B("data_upper_limit_language_version");
    }

    @Override // com.huawei.hicloud.notification.manager.NoticeCfgLanguageBaseManager
    public boolean getExtractResult() {
        return C10028c.m62182c0().m62324f0("data_upper_limit_language_download_result");
    }

    @Override // com.huawei.hicloud.notification.manager.NoticeCfgLanguageBaseManager
    public String getLanguageFilePath() {
        return C0213f.m1377a().getFilesDir() + File.separator + "data_upper_limit_language.xml";
    }
    ...
    public C11060c getStat() {
        if (this.stat == null) {
            C11060c c11060cM66626a = C11058a.m66626a(C11058a.m66627b("07065"), "07065", C13452e.m80781L().m80971t0());
    ...
    public void insertLanguageToDB(ArrayList<CommonLanguageDbString> arrayList) {
        try {
            new DataUpperLimitLanguageOperator().batchInsert(arrayList);
        } catch (Exception e10) {
    ...
    public void setCurrentLanguageHash(String str) {
        C10028c.m62182c0().m62381q2("data_upper_limit_language_hash", str);
    }

    @Override // com.huawei.hicloud.notification.manager.NoticeCfgLanguageBaseManager
    public void setCurrentLanguageVersion(int i10) {
        C10028c.m62182c0().m62386r2("data_upper_limit_language_version", i10);
    }

    @Override // com.huawei.hicloud.notification.manager.NoticeCfgLanguageBaseManager
    public void setExtractResult(boolean z10) {
        C10028c.m62182c0().m62281U2("data_upper_limit_language_download_result", z10);
    }
}
