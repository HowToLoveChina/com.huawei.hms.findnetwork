...
public class HiCloudCampaignNoticeRoot {
    ...
    private HiCloudMsgNoticeAction[] configBean;
    ...
    public HiCloudMsgNoticeAction[] getConfigBean() {
    ...
    public void setConfigBean(HiCloudMsgNoticeAction[] hiCloudMsgNoticeActionArr) {
        this.configBean = hiCloudMsgNoticeActionArr;
    }
