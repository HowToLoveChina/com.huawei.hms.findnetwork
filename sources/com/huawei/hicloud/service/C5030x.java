...
/* renamed from: com.huawei.hicloud.service.x */
/* loaded from: classes.dex */
public class C5030x extends AbstractC5012g {
    public C5030x(String str) {
        super(str);
    }
    ...
    public String getConfigFilePath() {
        return C0213f.m1377a().getFilesDir() + File.separator + "HiCloudSpaceFrequencyControl.json";
    }

    @Override // com.huawei.hicloud.service.AbstractC5012g
    public long getConfigVersion() throws C9721b {
        return getCfgVersion("HiCloudSpaceFrequencyControl");
    }
    ...
    public String getGeneralConfigVersionAddress() throws C9721b {
        return C13040c.m78609F().m78611B() + "/configserver/v2/hicloud/configs/changes?key=HiCloudSpaceFrequencyControl";
    }

    @Override // com.huawei.hicloud.service.AbstractC5012g
    public boolean getLatestConfig() throws C9721b {
        return getLatestConfig("HiCloudSpaceFrequencyControl");
    }
