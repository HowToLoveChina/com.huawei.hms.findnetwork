...
public class HiCloudSMSCallback extends AbstractC4977a {
    ...
    public void prepare(HttpRequestBuilder.a aVar) throws C9721b, NoSuchMethodException, IOException, SecurityException {
        ...
        aVar.addHeader("x-hw-device-category", C0209d.m1170F1() ? DEVICE_CATEGORY_TYPE_PAD : DEVICE_CATEGORY_TYPE_PHONE);
        ...
        if (!TextUtils.isEmpty(this.signature)) {
            aVar.addHeader("x-hw-signature", this.signature);
        }
        if (!TextUtils.isEmpty(this.sessionId)) {
            aVar.addHeader("x-hw-sessionID", this.sessionId);
        }
        aVar.addHeader("x-hw-device-type", C13452e.m80781L().m80970t());
    }
