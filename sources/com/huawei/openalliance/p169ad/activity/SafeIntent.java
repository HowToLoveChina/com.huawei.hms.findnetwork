...
public class SafeIntent extends Intent {
    ...
    public String getDataString() {
        try {
            ...
            AbstractC7185ho.m43824c("SafeIntent", "getDataStr err: %s", th2.getClass().getSimpleName());
            return "";
        }
    }
    ...
    public String getScheme() {
        try {
            ...
            AbstractC7185ho.m43824c("SafeIntent", "getScheme err: %s", th2.getClass().getSimpleName());
            return "";
        }
    }
    ...
    public void setSelector(Intent intent) {
        try {
            ...
            AbstractC7185ho.m43823c("SafeIntent", "setSelector ex.");
        }
    }
    ...
    public String toURI() {
        try {
            ...
            AbstractC7185ho.m43823c("SafeIntent", "toURI: exception " + th2.getClass().getSimpleName());
            return "";
        }
    }
    ...
    public String toUri(int i10) {
        try {
            ...
            AbstractC7185ho.m43823c("SafeIntent", "toUri ex.");
            return "";
        }
    }
