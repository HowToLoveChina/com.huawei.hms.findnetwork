...
public class C4343a extends C4348f {
    ...
    public void prepare(HttpRequestBuilder.a aVar) {
        String str;
        aVar.addHeader("x-hw-auth-version", "2");
        ...
        aVar.addHeader("AppAuthorization", str);
        aVar.addHeader("x-hw-os-brand", C0209d.m1276l0());
        aVar.addHeader("x-hw-client-mode", RequestModeConfig.getInstance().getMode(Integer.valueOf(this.f19835d)));
        aVar.addHeader("x-hw-framework-type", "0");
        if (3102 == this.f19835d) {
            aVar.addHeader("rsaVersion", InterfaceC5323b.f24693t);
        }
    }
}
