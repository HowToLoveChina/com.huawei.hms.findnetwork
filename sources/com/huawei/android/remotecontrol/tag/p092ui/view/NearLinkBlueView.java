...
public class NearLinkBlueView extends View {
    ...
    private static final String TAG = "NearLinkBlueView";
    ...
    public NearLinkBlueView(Context context, AttributeSet attributeSet) {
        ...
        float fSqrt = (int) Math.sqrt((iM70758Q * iM70758Q) + (iM70752O * iM70752O));
        this.finalDiameter = fSqrt;
        C13981a.m83989i(TAG, "NearLinkBlueView maxRadius:" + this.maxRadius + "minRadius:" + this.minRadius + "finalDiameter:" + fSqrt);
    }
    ...
    private void initOuterAnimator(int i10, int i11) {
        ...
        this.outerAnimator.setDuration(500L);
        this.outerAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: cg.h
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f6195a.lambda$initOuterAnimator$0(valueAnimator);
            }
        });
    ...
    public void initBlackScreen() {
        this.currentMaxRadius = 0;
        initOuterAnimator(0, 0);
    }

    public void initOuterAnimatorFullScreen() {
        int i10 = this.currentMaxRadius;
        int i11 = (int) this.finalDiameter;
        this.currentMaxRadius = i11;
        initOuterAnimator(i10, i11);
    }

    public void initOuterAnimatorVanishedScreen() {
        int iMax = Math.max(this.currentMaxRadius, this.minRadius);
        this.currentMaxRadius = 0;
        initOuterAnimator(iMax, 0);
    }
