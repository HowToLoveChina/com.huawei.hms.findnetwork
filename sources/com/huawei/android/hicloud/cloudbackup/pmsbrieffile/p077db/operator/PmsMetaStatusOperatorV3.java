...
public class PmsMetaStatusOperatorV3 extends AbstractC11478a<PmsMetaStatus> {
    private static final String TAG = "PmsMetaStatusOperatorV3";

    public PmsMetaStatusOperatorV3(String str) {
        super(C13216j.m79427l(C13216j.c.PMSBRIEF, str));
    }

    public void clear() throws C9721b {
        execSQL(String.format(Locale.ENGLISH, "delete from %s", PmsMetaDBScript.TABLE_NAME_META_STATUS_V3));
    }

    public boolean isExistTable() {
        try {
            Cursor cursorRawQuery = rawQuery(PmsMetaStatusDBScript.CHECK_METASTATUS_TABLE_EXIST_V3, null);
    ...
    public PmsMetaStatus query() throws C9721b {
        List<PmsMetaStatus> listQuery = query(PmsMetaStatusDBScript.QUERY_META_STATUS_V3, null);
        if (listQuery.size() <= 0) {
            return null;
        }
    ...
    public void replace(PmsMetaStatus pmsMetaStatus) throws C9721b {
        execSQL(PmsMetaStatusDBScript.REPLACE_PMSMETASTATUS_V3, getColumns(pmsMetaStatus));
    }

    public void updateModifytime(long j10) throws C9721b {
        execSQL(PmsMetaStatusDBScript.UPDATE_MODIFYTIME_V3, new String[]{String.valueOf(j10)});
    }

    public void updateStatus(int i10) throws C9721b {
        execSQL(PmsMetaStatusDBScript.UPDATE_STATUS_V3, new String[]{String.valueOf(i10)});
    }
