...
public class PmsBatchFilesInfoToCopyOperator extends PmsMetaBaseOperator {
    ...
    public void updateChangedFileInfoStatus() throws C9721b {
        ...
        String str = String.format(locale, PmsMetaDBScript.UPDATE_CHANGED_FILE_INFO_STATUS, PmsMetaDBScript.TABLE_NAME_BATCH_FILES_INFOTO_COPY, PmsMetaDBScript.TABLE_NAME_BATCH_FILES_INFO_COPY_SUCCESS);
        String[] strArr = {String.valueOf(1), String.valueOf(1)};
        execSQL(str, strArr);
        execSQL(String.format(locale, PmsMetaDBScript.UPDATE_CHANGED_FILE_INFO_TIME_SIZE, PmsMetaDBScript.TABLE_NAME_BATCH_FILES_INFOTO_COPY, PmsMetaDBScript.TABLE_NAME_BATCH_FILES_INFO_COPY_SUCCESS), strArr);
    }
