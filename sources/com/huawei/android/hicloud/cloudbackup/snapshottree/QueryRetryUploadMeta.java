...
public class QueryRetryUploadMeta extends QueryBackupMeta {
    public QueryRetryUploadMeta(String str, String str2) throws C9721b {
        super(str, str2);
    }
    ...
    public long initAllSize(String str) throws C9721b {
        return this.mMetaOperator.queryWaitDeleteFileCount(str);
    }

    @Override // com.huawei.android.hicloud.cloudbackup.snapshottree.QueryBackupMeta
    public List<SnapshotBackupMeta> queryBylimit(String str, long j10, long j11) throws C9721b {
        return this.mMetaOperator.queryWaitDeleteRetryFilesLimitByAppId(str, j10, j11);
    }
}
