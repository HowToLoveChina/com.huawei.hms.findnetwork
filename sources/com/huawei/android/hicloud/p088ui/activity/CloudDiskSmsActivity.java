...
import p426kd.AsyncTaskC11039m;
import p516ob.C11845a;

/* loaded from: classes3.dex */
public class CloudDiskSmsActivity extends CloudDiskOperateBaseActivity {
    ...
    public List<ModuleItem> mo19679e2() {
        return C11845a.m70927n(NavigationUtils.SMS_SCHEMA_PREF);
    }

    @Override // com.huawei.android.hicloud.p088ui.activity.CloudDiskOperateBaseActivity
    /* renamed from: f2 */
    public List<CBSDevice> mo19680f2() {
        return C11845a.m70928o(NavigationUtils.SMS_SCHEMA_PREF);
    }
    ...
    */
    public boolean mo19681g2(android.os.Message r4) {
        ...
        L3c:
            ...
            int r0 = com.huawei.android.sync.R$string.cloudbackup_back_item_sms
        ...
        L57:
            if (r4 != 0) goto L79
            java.lang.String r4 = "CloudDiskSmsActivity"
        ...
        La2:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.huawei.android.hicloud.p088ui.activity.CloudDiskSmsActivity.mo19681g2(android.os.Message):boolean");
    }

    @Override // com.huawei.android.hicloud.p088ui.activity.CloudDiskOperateBaseActivity
    /* renamed from: i2 */
    public boolean mo19682i2() {
        return AsyncTask.Status.RUNNING.equals(AsyncTaskC11039m.m66560c(getApplicationContext(), this.f14281u).getStatus());
    }

    @Override // com.huawei.android.hicloud.p088ui.activity.CloudDiskOperateBaseActivity
    /* renamed from: k2 */
    public void mo19683k2() {
        this.f14282v = "autosmslistkey";
        this.f14278r = this;
    }
    ...
    public void onCreate(Bundle bundle) throws IllegalAccessException, Resources.NotFoundException, ClassNotFoundException, IllegalArgumentException, InvocationTargetException {
        ...
        m22365E1(R$string.cloudbackup_back_item_sms);
    }

    @Override // com.huawei.android.hicloud.p088ui.activity.CloudDiskOperateBaseActivity, com.huawei.android.hicloud.p088ui.activity.UIActivity, com.huawei.hicloud.base.p103ui.uiextend.PermissionCheckActivity, android.app.Activity
    public void onDestroy() {
        AsyncTaskC11039m.m66560c(getApplicationContext(), null);
        super.onDestroy();
    }
    ...
    public void mo19684v2(boolean z10, boolean z11) {
        AsyncTaskC11039m asyncTaskC11039mM66560c = AsyncTaskC11039m.m66560c(getApplicationContext(), this.f14281u);
        asyncTaskC11039mM66560c.m66566g(z10);
        asyncTaskC11039mM66560c.m66565f(z11);
