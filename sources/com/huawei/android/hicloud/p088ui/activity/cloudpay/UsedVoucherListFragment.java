...
public class UsedVoucherListFragment extends VoucherListFragment {
    ...
    public void mo23522b(GetAllVouchersResp getAllVouchersResp) {
        C1442a.m8290i("UsedVoucherListFragment", "dealGetAllVouchersSuccess");
        m23875i().addAll(((GsonVoucher) C12540b1.m75483a("{\"usefulVouchers\":" + getAllVouchersResp.getUsedVouchers() + "}", GsonVoucher.class)).getUsefulVouchers());
    ...
    public void mo23523e(QueryPickedWelfaresResp queryPickedWelfaresResp) {
        C1442a.m8290i("UsedVoucherListFragment", "dealQueryPickedWelfaresSuccess");
        if (queryPickedWelfaresResp.getUsedWelfares() != null) {
            m23877k().addAll(queryPickedWelfaresResp.getUsedWelfares());
        } else {
            C1442a.m8288d("UsedVoucherListFragment", "dealQueryPickedWelfaresSuccess usedWelfares is null");
        }
        m23864C(true);
    }
    ...
    public void mo23524h() {
        if (C11296s.m67786J(getContext())) {
            C9158a.m57503F().m57520R(this.f17482o, new VouchersTaskInfo("0|1|2", m23879m("1"), "50", this.f17488u), m23873f());
            return;
        }
    ...
    public void mo23525q() {
        ...
        vouchersManagerAdapter.m25450v(this);
        this.f17481n.m25444o(C11842p.m70829k0(getActivity()));
        this.f17481n.m25447s(1);
    }
    ...
    public void mo23527v() {
        ...
        m23865D();
        C9158a.m57503F().m57520R(this.f17482o, new VouchersTaskInfo("0|1|2", "0100", "50", ""), m23873f());
    }
}
