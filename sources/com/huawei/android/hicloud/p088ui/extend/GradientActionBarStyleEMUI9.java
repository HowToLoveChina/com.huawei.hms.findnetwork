...
public class GradientActionBarStyleEMUI9 extends AbstractC3943a {
    public GradientActionBarStyleEMUI9(Context context) {
        ...
        this.f18019c = resources.getColor(R$color.hicloud_main_actionbar_background_color_scroll_9_0);
        this.f18021e = resources.getColor(R$color.hicloud_main_actionbar_title_color_scroll_9_0);
        this.f18023g = resources.getDrawable(R$drawable.ic_back_scroll_9_0);
        this.f18025i = resources.getDrawable(R$drawable.ic_service_scroll_9_0);
        this.f18027k = resources.getDrawable(R$drawable.ic_more_scroll_9_0);
        this.f18027k = resources.getDrawable(R$drawable.ic_sns_info_pic);
    }
}
