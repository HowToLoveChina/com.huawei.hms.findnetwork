...
public class EuropeSDKFileProxyDownloadTaskCallable extends DownloadTaskBaseCallable {
    public static final Timer DOWNPROGRESSTIMER = new Timer();
    private static final String TAG = "EuropeSDKFileProxyDownloadTaskCallable";
    ...
    public static class SDKDownloadProgressTask extends TimerTask {
        ...
        private CallbackHandler callbackHandler;
        private EuropeSDKFileProxyDownloadTaskCallable downloadTask;
        ...
        public SDKDownloadProgressTask(CallbackHandler callbackHandler, EuropeSDKFileProxyDownloadTaskCallable europeSDKFileProxyDownloadTaskCallable, FileInfo fileInfo, long j10, String str, int i10, boolean z10) {
            this.is3DPhoto = z10;
            this.callbackHandler = callbackHandler;
            this.downloadTask = europeSDKFileProxyDownloadTaskCallable;
    ...
    public EuropeSDKFileProxyDownloadTaskCallable(Context context, CallbackHandler callbackHandler, String str, String str2, Object obj, String str3, boolean z10, int i10, String str4, int i11, int i12, boolean z11, String str5, boolean z12) {
        super(obj, i10);
    ...
    private void cancelDownloadAndCallBack(int i10, int i11) {
        ...
        StringBuilder sb2 = new StringBuilder();
        sb2.append(this.fileInfo.getAlbumId());
        sb2.append("_");
        sb2.append(!zIsEmpty ? this.fileInfo.getUniqueId() : this.fileInfo.getHash());
        sb2.append("_");
        sb2.append(((DownloadTaskBaseCallable) this).thumbType);
        sb2.append("_");
        String string = sb2.toString();
        C13914b c13914b = new C13914b(this.context, this.callbackHandler);
        C13914b.m83362u(this.callbackHandler, this.taskType, string, 2, null, zIsEmpty);
    ...
    public Object call() throws Exception {
        ...
        if (zCheckDir && zCheckDir2) {
            ...
            this.res.put("code", downloadResult(this.context, mapCheckFileBreakSize.get("fileSize").longValue(), mapCheckFileBreakSize.get("breakPointSize").longValue()));
            this.res.put("isForceDownload", Boolean.valueOf(this.isForceDownload));
    ...
    public int checkDownloadUrl() {
        ...
        if (iM57058s == 0) {
            ...
            } else if ((i10 == 1 || i10 == 2) && !TextUtils.isEmpty(this.fileInfo.getThumbUrl())) {
    ...
    public String downloadFinishRename(String str) {
        C1120a.m6675d(TAG, "localDownloadCachePath: " + str);
    ...
    public void handleCloseExecuting() {
        C1120a.m6675d(TAG, "closeDownProgressTask start");
        ...
        if (sDKDownloadProgressTask != null) {
            try {
                ...
                C1120a.m6676e(TAG, "download file downProgressTask cancel error!error message:" + e10.getMessage());
            }
        }
    }
