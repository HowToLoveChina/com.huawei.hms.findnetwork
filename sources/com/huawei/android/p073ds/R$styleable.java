...
public final class R$styleable {
    ...
    public static final int AutoStyleButton_Style_defStyle = 0;
    public static final int AutoStyleButton_Style_newStyle = 1;
    ...
    public static final int CloudRoundPercentBar_cloudMax = 1;
    public static final int CloudRoundPercentBar_cloudNumTextSize = 2;
    public static final int CloudRoundPercentBar_cloudPercentTextSize = 3;
    public static final int CloudRoundPercentBar_cloudRectWidth = 4;
    public static final int CloudRoundPercentBar_cloudTextColor = 5;
    public static final int CloudRoundPercentBar_cloudTextSize = 6;
    public static final int CloudRoundPercentBar_cloudUsageColor = 7;
    ...
    public static final int f11459xfdeff96 = 1;

    /* renamed from: ConstraintLayout_ReactiveGuide_reactiveGuide_applyToConstraintSet */
    public static final int f11460x2694048c = 2;
    ...
    public static final int CustomRoundImageView_corner_bottom_left_radius = 0;
    public static final int CustomRoundImageView_corner_bottom_right_radius = 1;
    public static final int CustomRoundImageView_corner_radius = 2;
    public static final int CustomRoundImageView_corner_top_left_radius = 3;
    public static final int CustomRoundImageView_corner_top_right_radius = 4;
    ...
    public static final int GradientCircleProgress_gcp_circleColor = 0;
    public static final int GradientCircleProgress_gcp_endColor = 1;
    public static final int GradientCircleProgress_gcp_max = 2;
    public static final int GradientCircleProgress_gcp_progress = 3;
    public static final int GradientCircleProgress_gcp_progressColor = 4;
    public static final int GradientCircleProgress_gcp_progressWidth = 5;
    public static final int GradientCircleProgress_gcp_startAngle = 6;
    public static final int GradientCircleProgress_gcp_startColor = 7;
    public static final int GradientCircleProgress_gcp_symbolColor = 8;
    public static final int GradientCircleProgress_gcp_symbolSize = 9;
    public static final int GradientCircleProgress_gcp_textColor = 10;
    public static final int GradientCircleProgress_gcp_textSize = 11;
    ...
    public static final int HiCloudDotsPageIndicator_dotSize = 0;
    public static final int HiCloudDotsPageIndicator_gap = 1;
    public static final int HiCloudDotsPageIndicator_isAutoPlay = 2;
    public static final int HiCloudDotsPageIndicator_isShowAsDot = 3;
    public static final int HiCloudDotsPageIndicator_selectedDotColor = 4;
    public static final int HiCloudDotsPageIndicator_selectedDotWidth = 5;
    public static final int HiCloudDotsPageIndicator_unselectedDotColor = 6;
    ...
    public static final int f11463xdfd7bb1e = 4;
    ...
    public static final int f11464x97d79ce4 = 6;

    /* renamed from: HwGravitationalLoadingAnimation_hwProgressBarDimensionScaleBaseline */
    public static final int f11465x56c4edef = 7;
    ...
    public static final int f11466x374ba37a = 1;
    ...
    public static final int MyCircleWave_CircleType = 0;
    public static final int MyCircleWave_MyCircleWaveColor = 1;
    public static final int MyCircleWave_MyCircleWaveMaxRadius = 2;
    public static final int MyCircleWave_MyCircleWaveMinRadius = 3;
    ...
    public static final int PfItem_pf_arrow_expland_visible = 0;
    public static final int PfItem_pf_detail_layout = 1;
    public static final int PfItem_pf_diliver_above_visible = 2;
    public static final int PfItem_pf_diliver_bottom_visible = 3;
    public static final int PfItem_pf_oobe = 4;
    public static final int PfItem_pf_show_state = 5;
    public static final int PfItem_pf_show_state_text = 6;
    public static final int PfItem_pf_subtext = 7;
    public static final int PfItem_pf_subtext_single = 8;
    public static final int PfItem_pf_subtext_visible = 9;
    public static final int PfItem_pf_switch_visible = 10;
    public static final int PfItem_pf_text = 11;
    public static final int PfItem_pf_text_single = 12;
    public static final int PfSpanClickText_needBold = 0;
    public static final int PfSpanClickText_pf_spanBgColor = 1;
    public static final int PfSpanClickText_pf_spanClickColor = 2;
    public static final int PfSpanClickText_pf_spanColor = 3;
    public static final int PfSpanClickText_pf_spanFamily = 4;
    ...
    public static final int RenewAgreementTextview_isv5Dialog = 0;
    public static final int RoundProgressBar_bigTextColor = 0;
    public static final int RoundProgressBar_bigTextSize = 1;
    public static final int RoundProgressBar_max = 2;
    public static final int RoundProgressBar_radius = 3;
    public static final int RoundProgressBar_roundBgColor = 4;
    public static final int RoundProgressBar_roundProgressColor = 5;
    public static final int RoundProgressBar_smallTextColor = 6;
    public static final int RoundProgressBar_smallTextSize = 7;
    public static final int RoundProgressBar_strokeWidth = 8;
    public static final int RoundProgressBar_style = 9;
    public static final int RoundProgressBar_textIsDisplayable = 10;
    public static final int RoundProgressBar_textMarginTop = 11;
    public static final int RoundRectImageView_border_color = 0;
    public static final int RoundRectImageView_border_enable = 1;
    public static final int RoundRectImageView_border_width = 2;
    public static final int RoundRectImageView_hidisk_shape_mode = 3;
    public static final int RoundRectImageView_round_radius = 4;
    public static final int ScaleRoundRectImageView_sriRadius = 0;
    ...
    public static final int SlidingUpPanelLayout_panelMarginTop = 5;
    public static final int SlidingUpPanelLayout_paralaxOffset = 6;
    public static final int SlidingUpPanelLayout_shadowHeight = 7;
    public static final int SlidingUpPanelLayout_showShadow = 8;
    ...
    public static final int TextBannerViewStyle_maxLine = 0;
    public static final int TextBannerViewStyle_setAnimDuration = 1;
    public static final int TextBannerViewStyle_setDirection = 2;
    public static final int TextBannerViewStyle_setFlags = 3;
    public static final int TextBannerViewStyle_setGravity = 4;
    public static final int TextBannerViewStyle_setInterval = 5;
    public static final int TextBannerViewStyle_setSingleLine = 6;
    public static final int TextBannerViewStyle_setTextColor = 7;
    public static final int TextBannerViewStyle_setTextSize = 8;
    public static final int TextBannerViewStyle_setTypeface = 9;
    public static final int TextBannerViewStyle_textStyleId = 10;
    ...
    public static final int account_logout_item_attr_account_logout_item_divider = 0;
    public static final int account_logout_item_attr_account_logout_item_img = 1;
    public static final int account_logout_item_attr_account_logout_item_title = 2;
    public static final int account_logout_item_attr_account_logout_module_disable = 3;
    public static final int account_logout_item_attr_account_logout_switch_checked = 4;
    public static final int backup_base_data_showCheckBox = 0;
    public static final int backup_base_data_showEneArrow = 1;
    public static final int backup_base_data_showTips = 2;
    public static final int backup_temp_select_space_needClick = 0;
    public static final int cleanup_item_attr_cleanup_item_img = 0;
    public static final int cleanup_item_attr_cleanup_item_title = 1;
    public static final int cleanup_item_attr_cleanup_sub_title = 2;
    public static final int count_down_timer_prefixText = 0;
    ...
    public static final int hicloud_exception_attr_exception_arrow = 0;
    public static final int hicloud_exception_attr_exception_content = 1;
    public static final int hicloud_exception_attr_exception_handle_msg = 2;
    public static final int hicloud_exception_attr_exception_img = 3;
    public static final int hicloud_item_attr_endtext_support_min_width = 0;
    public static final int hicloud_item_attr_hide_img = 1;
    public static final int hicloud_item_attr_icon_size = 2;
    public static final int hicloud_item_attr_item_divider = 3;
    public static final int hicloud_item_attr_item_divider_align_start = 4;
    public static final int hicloud_item_attr_item_img = 5;
    public static final int hicloud_item_attr_item_title = 6;
    public static final int hicloud_item_attr_loading = 7;
    public static final int hicloud_item_attr_min_height = 8;
    public static final int hicloud_item_attr_module_disable_hide = 9;
    public static final int hicloud_item_attr_no_need_notch_fit = 10;
    public static final int hicloud_item_attr_show_end_status_frame_view = 11;
    public static final int hicloud_item_attr_show_switch = 12;
    public static final int hicloud_item_attr_status_text = 13;
    public static final int hicloud_item_attr_sub_title = 14;
    public static final int hicloud_item_attr_sub_title_width_limited = 15;
    public static final int hicloud_item_attr_sub_user_disable = 16;
    public static final int hicloud_item_attr_title_text_size = 17;
    public static final int hicloud_vertical_item_attr_vertical_item_img = 0;
    public static final int hicloud_vertical_item_attr_vertical_item_title = 1;
    public static final int hicloud_vertical_item_attr_vertical_loading = 2;
    public static final int hicloud_vertical_item_attr_vertical_min_height = 3;
    public static final int hicloud_vertical_item_attr_vertical_module_disable_hide = 4;
    public static final int hicloud_vertical_item_attr_vertical_status_text = 5;
    public static final int hicloud_vertical_item_attr_vertical_sub_title = 6;
    public static final int hicloud_vertical_item_attr_vertical_sub_user_disable = 7;
    public static final int hot_title_textview_attr_red_dot_visibility = 0;
    public static final int include_constraintSet = 0;
    public static final int list_item_with_2_textview_style_left_text = 0;
    public static final int list_item_with_2_textview_style_left_text_style = 1;
    public static final int list_item_with_2_textview_style_right_text = 2;
    public static final int list_item_with_2_textview_style_right_text_style = 3;
    public static final int notch_style_isFullScreen = 0;
    public static final int oobe_margin_relative_layout_attr_need_margin = 0;
    public static final int oobe_nav_attr_oobeNavBackColor = 0;
    public static final int oobe_nav_attr_oobeNavBackText = 1;
    public static final int oobe_nav_attr_oobeNavNextColor = 2;
    public static final int oobe_nav_attr_oobeNavNextText = 3;
    public static final int oobe_nav_attr_oobeNavShowDrawableBack = 4;
    public static final int oobe_nav_attr_oobeNavShowDrawableNext = 5;
    public static final int oobe_top_attr_is_uniform_layout = 0;
    public static final int oobe_top_attr_top_img = 1;
    public static final int oobe_top_attr_top_img_foreign = 2;
    public static final int oobe_top_attr_top_img_region_diff = 3;
    public static final int oobe_top_attr_top_is_migrate = 4;
    public static final int oobe_top_attr_top_need_video = 5;
    public static final int oobe_top_attr_top_sub_title = 6;
    public static final int oobe_top_attr_top_title = 7;
    public static final int oobe_top_attr_top_view_bottom_margin_cn = 8;
    public static final int oobe_top_attr_top_view_bottom_margin_non_cn = 9;
    public static final int price_desc_dialog_attr_tv_space = 0;
    public static final int price_desc_dialog_attr_tv_text_color = 1;
    public static final int price_desc_dialog_attr_tv_text_size = 2;
    public static final int price_desc_dialog_attr_tv_text_typeface = 3;
    public static final int round_corner_image_attr_cornerRadius = 0;
    public static final int storage_bar_need_loading = 0;
    public static final int storage_bar_use_cache = 1;
    public static final int storage_manager_card_layout_card_end_text_support_min_width = 0;
    public static final int storage_manager_card_layout_card_icon_size = 1;
    public static final int storage_manager_card_layout_card_img = 2;
    public static final int storage_manager_card_layout_card_is_family_share_item = 3;
    public static final int storage_manager_card_layout_card_min_height = 4;
    public static final int storage_manager_card_layout_card_sub_title = 5;
    public static final int storage_manager_card_layout_card_title = 6;
    public static final int storage_manager_cardview_layout_cardview_bg_default = 0;
    public static final int storage_manager_cardview_layout_cardview_img = 1;
    public static final int storage_manager_cardview_layout_cardview_manage_divider = 2;
    public static final int storage_manager_cardview_layout_cardview_min_height = 3;
    public static final int storage_manager_cardview_layout_cardview_size = 4;
    public static final int storage_manager_cardview_layout_cardview_title = 5;
    public static final int storage_manager_cardview_layout_is_family_share_item = 6;
    public static final int storage_manager_item_layout_img = 0;
    public static final int storage_manager_item_layout_manage_divider = 1;
    public static final int storage_manager_item_layout_num = 2;
    public static final int storage_manager_item_layout_size = 3;
    public static final int storage_manager_item_layout_title = 4;
    public static final int text_btn_card_attr_btn_text = 0;
    public static final int text_btn_card_attr_content_text = 1;
    public static final int vipCardBgStyle_bg_center_color = 0;
    public static final int vipCardBgStyle_bg_end_color = 1;
    public static final int vipCardBgStyle_bg_gradient_angle = 2;
    public static final int vipCardBgStyle_bg_gradient_center = 3;
    public static final int vipCardBgStyle_bg_start_color = 4;
    public static final int vipCardBgStyle_border_end_color = 5;
    public static final int vipCardBgStyle_border_start_color = 6;
    public static final int vipCardBgStyle_cloud_path_color = 7;
    public static final int vipCardBgStyle_petalone_ic_bg_end_color = 8;
    public static final int vipCardBgStyle_petalone_ic_bg_start_color = 9;
    public static final int vipCardBgStyle_petalone_ic_fg_color = 10;
    public static final int vipCardBgStyle_progress_bar_background_color = 11;
    public static final int vipCardBgStyle_progress_bar_progress_color = 12;
    public static final int vipCardBgStyle_vip_card_cloud_fillalpha = 13;
    public static final int vipCardBgStyle_vip_card_text_color = 14;
    public static final int vouchercolumnview_attr_is_need_second_line_show = 0;
    ...
    public static final int[] AutoStyleButton_Style = {C5035R.attr.defStyle, C5035R.attr.newStyle};
    ...
    public static final int[] CloudRoundPercentBar = {C5035R.attr.cloudBackgroundColor, C5035R.attr.cloudMax, C5035R.attr.cloudNumTextSize, C5035R.attr.cloudPercentTextSize, C5035R.attr.cloudRectWidth, C5035R.attr.cloudTextColor, C5035R.attr.cloudTextSize, C5035R.attr.cloudUsageColor};
    ...
    public static final int[] CustomRoundImageView = {C5035R.attr.corner_bottom_left_radius, C5035R.attr.corner_bottom_right_radius, C5035R.attr.corner_radius, C5035R.attr.corner_top_left_radius, C5035R.attr.corner_top_right_radius};
    ...
    public static final int[] DynamicLinearView = {C5035R.attr.childcount, C5035R.attr.fortune, C5035R.attr.layoutid, C5035R.attr.titleText};
    ...
    public static final int[] FlexboxLayout = {C5035R.attr.alignContent, C5035R.attr.alignItems, C5035R.attr.dividerDrawable, C5035R.attr.dividerDrawableHorizontal, C5035R.attr.dividerDrawableVertical, C5035R.attr.flexDirection, C5035R.attr.flexWrap, C5035R.attr.justifyContent, C5035R.attr.maxLine, C5035R.attr.showDivider, C5035R.attr.showDividerHorizontal, C5035R.attr.showDividerVertical};
    public static final int[] FlexboxLayout_Layout = {C5035R.attr.layout_alignSelf, C5035R.attr.layout_flexBasisPercent, C5035R.attr.layout_flexGrow, C5035R.attr.layout_flexShrink, C5035R.attr.layout_maxHeight, C5035R.attr.layout_maxWidth, C5035R.attr.layout_minHeight, C5035R.attr.layout_minWidth, C5035R.attr.layout_order, C5035R.attr.layout_wrapBefore};
    ...
    public static final int[] GradientCircleProgress = {C5035R.attr.gcp_circleColor, C5035R.attr.gcp_endColor, C5035R.attr.gcp_max, C5035R.attr.gcp_progress, C5035R.attr.gcp_progressColor, C5035R.attr.gcp_progressWidth, C5035R.attr.gcp_startAngle, C5035R.attr.gcp_startColor, C5035R.attr.gcp_symbolColor, C5035R.attr.gcp_symbolSize, C5035R.attr.gcp_textColor, C5035R.attr.gcp_textSize};
    ...
    public static final int[] HiCloudDotsPageIndicator = {C5035R.attr.dotSize, C5035R.attr.gap, C5035R.attr.isAutoPlay, C5035R.attr.isShowAsDot, C5035R.attr.selectedDotColor, C5035R.attr.selectedDotWidth, C5035R.attr.unselectedDotColor};
    ...
    public static final int[] MyCircleWave = {C5035R.attr.CircleType, C5035R.attr.MyCircleWaveColor, C5035R.attr.MyCircleWaveMaxRadius, C5035R.attr.MyCircleWaveMinRadius};
    ...
    public static final int[] PfItem = {C5035R.attr.pf_arrow_expland_visible, C5035R.attr.pf_detail_layout, C5035R.attr.pf_diliver_above_visible, C5035R.attr.pf_diliver_bottom_visible, C5035R.attr.pf_oobe, C5035R.attr.pf_show_state, C5035R.attr.pf_show_state_text, C5035R.attr.pf_subtext, C5035R.attr.pf_subtext_single, C5035R.attr.pf_subtext_visible, C5035R.attr.pf_switch_visible, C5035R.attr.pf_text, C5035R.attr.pf_text_single};
    public static final int[] PfSpanClickText = {C5035R.attr.needBold, C5035R.attr.pf_spanBgColor, C5035R.attr.pf_spanClickColor, C5035R.attr.pf_spanColor, C5035R.attr.pf_spanFamily};
    ...
    public static final int[] RenewAgreementTextview = {C5035R.attr.isv5Dialog};
    public static final int[] RoundProgressBar = {C5035R.attr.bigTextColor, C5035R.attr.bigTextSize, C5035R.attr.max, C5035R.attr.radius, C5035R.attr.roundBgColor, C5035R.attr.roundProgressColor, C5035R.attr.smallTextColor, C5035R.attr.smallTextSize, C5035R.attr.strokeWidth, C5035R.attr.style, C5035R.attr.textIsDisplayable, C5035R.attr.textMarginTop};
    public static final int[] RoundRectImageView = {C5035R.attr.border_color, C5035R.attr.border_enable, C5035R.attr.border_width, C5035R.attr.hidisk_shape_mode, C5035R.attr.round_radius};
    public static final int[] ScaleRoundRectImageView = {C5035R.attr.sriRadius};
    ...
    public static final int[] SlidingUpPanelLayout = {C5035R.attr.dragView, C5035R.attr.fadeColor, C5035R.attr.flingVelocity, C5035R.attr.overlay, C5035R.attr.panelHeight, C5035R.attr.panelMarginTop, C5035R.attr.paralaxOffset, C5035R.attr.shadowHeight, C5035R.attr.showShadow};
    ...
    public static final int[] StretchTextView = {C5035R.attr.layoutalign, C5035R.attr.mSpacingAdd, C5035R.attr.mSpacingMult};
    ...
    public static final int[] TextBannerViewStyle = {C5035R.attr.maxLine, C5035R.attr.setAnimDuration, C5035R.attr.setDirection, C5035R.attr.setFlags, C5035R.attr.setGravity, C5035R.attr.setInterval, C5035R.attr.setSingleLine, C5035R.attr.setTextColor, C5035R.attr.setTextSize, C5035R.attr.setTypeface, C5035R.attr.textStyleId};
    ...
    public static final int[] account_logout_item_attr = {C5035R.attr.account_logout_item_divider, C5035R.attr.account_logout_item_img, C5035R.attr.account_logout_item_title, C5035R.attr.account_logout_module_disable, C5035R.attr.account_logout_switch_checked};
    public static final int[] backup_base_data = {C5035R.attr.showCheckBox, C5035R.attr.showEneArrow, C5035R.attr.showTips};
    public static final int[] backup_temp_select_space = {C5035R.attr.needClick};
    public static final int[] cleanup_item_attr = {C5035R.attr.cleanup_item_img, C5035R.attr.cleanup_item_title, C5035R.attr.cleanup_sub_title};
    public static final int[] count_down_timer = {C5035R.attr.prefixText};
    ...
    public static final int[] hicloud_exception_attr = {C5035R.attr.exception_arrow, C5035R.attr.exception_content, C5035R.attr.exception_handle_msg, C5035R.attr.exception_img};
    public static final int[] hicloud_item_attr = {C5035R.attr.endtext_support_min_width, C5035R.attr.hide_img, C5035R.attr.icon_size, C5035R.attr.item_divider, C5035R.attr.item_divider_align_start, C5035R.attr.item_img, C5035R.attr.item_title, C5035R.attr.loading, C5035R.attr.min_height, C5035R.attr.module_disable_hide, C5035R.attr.no_need_notch_fit, C5035R.attr.show_end_status_frame_view, C5035R.attr.show_switch, C5035R.attr.status_text, C5035R.attr.sub_title, C5035R.attr.sub_title_width_limited, C5035R.attr.sub_user_disable, C5035R.attr.title_text_size};
    public static final int[] hicloud_vertical_item_attr = {C5035R.attr.vertical_item_img, C5035R.attr.vertical_item_title, C5035R.attr.vertical_loading, C5035R.attr.vertical_min_height, C5035R.attr.vertical_module_disable_hide, C5035R.attr.vertical_status_text, C5035R.attr.vertical_sub_title, C5035R.attr.vertical_sub_user_disable};
    public static final int[] hot_title_textview_attr = {C5035R.attr.red_dot_visibility};
    public static final int[] include = {C5035R.attr.constraintSet};
    public static final int[] list_item_with_2_textview_style = {C5035R.attr.left_text, C5035R.attr.left_text_style, C5035R.attr.right_text, C5035R.attr.right_text_style};
    public static final int[] notch_style = {C5035R.attr.isFullScreen};
    public static final int[] oobe_margin_relative_layout_attr = {C5035R.attr.need_margin};
    public static final int[] oobe_nav_attr = {C5035R.attr.oobeNavBackColor, C5035R.attr.oobeNavBackText, C5035R.attr.oobeNavNextColor, C5035R.attr.oobeNavNextText, C5035R.attr.oobeNavShowDrawableBack, C5035R.attr.oobeNavShowDrawableNext};
    public static final int[] oobe_top_attr = {C5035R.attr.is_uniform_layout, C5035R.attr.top_img, C5035R.attr.top_img_foreign, C5035R.attr.top_img_region_diff, C5035R.attr.top_is_migrate, C5035R.attr.top_need_video, C5035R.attr.top_sub_title, C5035R.attr.top_title, C5035R.attr.top_view_bottom_margin_cn, C5035R.attr.top_view_bottom_margin_non_cn};
    public static final int[] price_desc_dialog_attr = {C5035R.attr.tv_space, C5035R.attr.tv_text_color, C5035R.attr.tv_text_size, C5035R.attr.tv_text_typeface};
    public static final int[] round_corner_image_attr = {C5035R.attr.cornerRadius};
    public static final int[] storage_bar = {C5035R.attr.need_loading, C5035R.attr.use_cache};
    public static final int[] storage_manager_card_layout = {C5035R.attr.card_end_text_support_min_width, C5035R.attr.card_icon_size, C5035R.attr.card_img, C5035R.attr.card_is_family_share_item, C5035R.attr.card_min_height, C5035R.attr.card_sub_title, C5035R.attr.card_title};
    public static final int[] storage_manager_cardview_layout = {C5035R.attr.cardview_bg_default, C5035R.attr.cardview_img, C5035R.attr.cardview_manage_divider, C5035R.attr.cardview_min_height, C5035R.attr.cardview_size, C5035R.attr.cardview_title, C5035R.attr.is_family_share_item};
    public static final int[] storage_manager_item_layout = {C5035R.attr.img, C5035R.attr.manage_divider, C5035R.attr.num, C5035R.attr.size, C5035R.attr.title};
    public static final int[] text_btn_card_attr = {C5035R.attr.btn_text, C5035R.attr.content_text};
    public static final int[] vipCardBgStyle = {C5035R.attr.bg_center_color, C5035R.attr.bg_end_color, C5035R.attr.bg_gradient_angle, C5035R.attr.bg_gradient_center, C5035R.attr.bg_start_color, C5035R.attr.border_end_color, C5035R.attr.border_start_color, C5035R.attr.cloud_path_color, C5035R.attr.petalone_ic_bg_end_color, C5035R.attr.petalone_ic_bg_start_color, C5035R.attr.petalone_ic_fg_color, C5035R.attr.progress_bar_background_color, C5035R.attr.progress_bar_progress_color, C5035R.attr.vip_card_cloud_fillalpha, C5035R.attr.vip_card_text_color};
    public static final int[] vouchercolumnview_attr = {C5035R.attr.is_need_second_line_show};
