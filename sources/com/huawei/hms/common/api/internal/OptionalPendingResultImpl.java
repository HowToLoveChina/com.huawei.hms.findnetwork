...
public final class OptionalPendingResultImpl<R extends Result> extends OptionalPendingResult<R> {
    ...
    /* renamed from: a */
    private final PendingResult<R> f23449a;

    public OptionalPendingResultImpl(PendingResult<R> pendingResult) {
        this.f23449a = pendingResult;
    }
    ...
    public final void setResultCallback(ResultCallback<R> resultCallback) {
        this.f23449a.setResultCallback(resultCallback);
    }

    @Override // com.huawei.hms.support.api.client.PendingResult
    public final R await(long j10, TimeUnit timeUnit) {
        return (R) this.f23449a.await(j10, timeUnit);
    }

    @Override // com.huawei.hms.support.api.client.PendingResult
    public void setResultCallback(Looper looper, ResultCallback<R> resultCallback) {
        this.f23449a.setResultCallback(looper, resultCallback);
    }
