...
public final class DataBufferUtils {
    ...
    /* renamed from: a */
    private static boolean m30665a(Bundle bundle, String str) {
    ...
    public static <T, E extends Freezable<T>> ArrayList<T> freezeAndClose(DataBuffer<E> dataBuffer) {
        ...
        BackupConstant.C21561 c21561 = (ArrayList<T>) new ArrayList(dataBuffer.getCount());
    ...
    public static boolean hasNextPage(DataBuffer<?> dataBuffer) {
        ...
        return m30665a(dataBuffer.getMetadata(), NEXT_PAGE);
    }
    ...
    public static boolean hasPrevPage(DataBuffer<?> dataBuffer) {
        ...
        return m30665a(dataBuffer.getMetadata(), PREV_PAGE);
    }
}
