...
public abstract class AbstractPickerAccount extends AbstractAuthAccount implements Parcelable {
    ...
    public AbstractPickerAccount(String str, String str2, String str3, String str4, String str5, String str6, int i10, int i11, Set<Scope> set, String str7, String str8, String str9, int i12, int i13) {
        this.openId = str;
        this.uid = str2;
    ...
    private void putJsonObject(JSONObject jSONObject, String str, Object obj, boolean z10) throws JSONException {
        if (!z10) {
    ...
    public void parserJson(JSONObject jSONObject) throws JSONException {
        ...
        if (jSONArray != null) {
            ...
            for (int i10 = 0; i10 < jSONArray.length(); i10++) {
                String strOptString = jSONArray.getJSONObject(i10).optString("mScopeUri", null);
        ...
        if (jSONObject.toString().contains(CommonConstant.KEY_EXPIRATION_TIME_SECS)) {
            try {
                ...
                C12836o.m77099d(TAG, "NumberFormatException", true);
            }
        }
    ...
    public void setAccountAttr(int i10) {
        this.accountAttr = i10;
    }
    ...
    public AbstractPickerAccount(Parcel parcel) {
