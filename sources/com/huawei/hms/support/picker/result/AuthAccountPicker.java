...
public class AuthAccountPicker extends AbstractPickerAccount {
    public static final Parcelable.Creator<AbstractPickerAccount> CREATOR = new Parcelable.Creator<AbstractPickerAccount>() { // from class: com.huawei.hms.support.picker.result.AuthAccountPicker.1
        ...
        public AbstractPickerAccount[] newArray2(int i10) {
            return new AuthAccountPicker[i10];
        }
    };
    private static final String TAG = "AuthAccountPicker";

    public AuthAccountPicker(String str, String str2, String str3, String str4, String str5, String str6, int i10, int i11, Set<Scope> set, String str7, String str8, String str9, int i12, int i13) {
        this.openId = str;
        this.uid = str2;
        ...
        this.carrierId = i12;
        this.accountAttr = i13;
    }

    public static AuthAccountPicker build(String str, String str2, String str3, String str4, String str5, String str6, int i10, int i11, Set<Scope> set, String str7, String str8, String str9, int i12, int i13) {
        return new AuthAccountPicker(str, str2, str3, str4, str5, str6, i10, i11, set, str7, str8, str9, i12, i13);
    }
    ...
    public AuthAccountPicker(Parcel parcel) {
