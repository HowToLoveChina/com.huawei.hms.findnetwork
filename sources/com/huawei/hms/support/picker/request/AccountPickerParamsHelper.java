...
public final class AccountPickerParamsHelper extends AbstractAuthParamsHelper {
    ...
    public AccountPickerParams createParams() throws JSONException {
        C12836o.m77097b(TAG, "begin createParams", true);
        JSONObject jSONObject = new JSONObject();
        try {
            jSONObject.put(CommonPickerConstant.RequestParams.KEY_REDIRECT_URL, this.mRedirectUrl);
            jSONObject.put(CommonPickerConstant.RequestParams.KEY_DEVICE_INFO, this.mDeviceInfo);
            ...
            C12836o.m77099d(TAG, "JSONException occur", true);
        }
    ...
    public AccountPickerParamsHelper setIdTokenSignAlg(int i10) {
        this.mIdTokenSignAlg = i10;
        return this;
    }

    public AccountPickerParamsHelper setIncludeGranted(boolean z10) {
        if (!z10) {
            PermissionInfo permissionInfo = new PermissionInfo();
    ...
    public AccountPickerParamsHelper setIsGuideLogin(boolean z10) {
    ...
    public AccountPickerParamsHelper setOobeFlag(boolean z10) {
        this.mOobeFlag = z10;
        return this;
    }
