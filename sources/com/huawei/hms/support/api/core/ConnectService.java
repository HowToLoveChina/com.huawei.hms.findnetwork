...
public final class ConnectService {
    ...
    public class C6321a extends PendingResultImpl<ResolveResult<ConnectResp>, ConnectResp> {
        public C6321a(ApiClient apiClient, String str, IMessageEntity iMessageEntity) {
        ...
        public ResolveResult<ConnectResp> onComplete(ConnectResp connectResp) {
            ...
            HMSLog.m36983d("connectservice", "connect - onComplete: success");
    ...
    public class C6322b extends PendingResultImpl<ResolveResult<ConnectResp>, ConnectResp> {
        public C6322b(ApiClient apiClient, String str, IMessageEntity iMessageEntity) {
            super(apiClient, str, iMessageEntity);
        }
        ...
        public ResolveResult<ConnectResp> onComplete(ConnectResp connectResp) {
            ResolveResult<ConnectResp> resolveResult = new ResolveResult<>(connectResp);
            resolveResult.setStatus(Status.SUCCESS);
            HMSLog.m36983d("connectservice", "forceConnect - onComplete: success");
            return resolveResult;
        }
    ...
    public class C6323c extends PendingResultImpl<ResolveResult<JosGetNoticeResp>, JosGetNoticeResp> {
        public C6323c(ApiClient apiClient, String str, IMessageEntity iMessageEntity) {
            super(apiClient, str, iMessageEntity);
        }
        ...
        public ResolveResult<JosGetNoticeResp> onComplete(JosGetNoticeResp josGetNoticeResp) {
            if (josGetNoticeResp == null) {
                HMSLog.m36986e("connectservice", "JosNoticeResp is null");
                return null;
            }
            HMSLog.m36988i("connectservice", "josNoticeResp status code :" + josGetNoticeResp.getStatusCode());
    ...
    public static PendingResult<ResolveResult<ConnectResp>> connect(ApiClient apiClient, ConnectInfo connectInfo) {
        return new C6321a(apiClient, CoreNaming.CONNECT, connectInfo);
    }
    ...
    public static PendingResult<ResolveResult<ConnectResp>> forceConnect(ApiClient apiClient, ConnectInfo connectInfo) {
        return new C6322b(apiClient, CoreNaming.FORECONNECT, connectInfo);
    }
    ...
    public static PendingResult<ResolveResult<JosGetNoticeResp>> getNotice(ApiClient apiClient, int i10, String str) {
        ...
        return new C6323c(apiClient, CoreNaming.GETNOTICE, josGetNoticeReq);
    }
}
