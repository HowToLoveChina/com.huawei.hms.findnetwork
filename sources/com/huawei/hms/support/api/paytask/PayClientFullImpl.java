...
public class PayClientFullImpl implements PayClient {
    ...
    public Task<PayResult> addWithholdingPlan(WithholdRequest withholdRequest) {
        ...
        HiAnalyticsClient.reportEntry(this.f29848a, PayNaming.FULL_WITHHOLD, 61606301);
        return new FullSdkWithholdTask(this.f29848a, withholdRequest);
    }

    @Override // com.huawei.hms.support.api.paytask.PayClient
    public Task<OrderResult> getOrderDetail(OrderRequest orderRequest) {
        Checker.checkNonNull(orderRequest);
        HiAnalyticsClient.reportEntry(this.f29848a, PayNaming.FULL_GETORDERDETAIL, 61606301);
        return new OrderDetailTask(this.f29848a, orderRequest);
    }
    ...
    public Task<ProductDetailResult> getProductDetails(ProductDetailRequest productDetailRequest) {
        ...
        HiAnalyticsClient.reportEntry(this.f29848a, PayNaming.FULL_PRODUCTDETAIL, 61606301);
        return new ProductDetailTask(this.f29848a, productDetailRequest);
    }
    ...
    public Task<PurchaseInfoResult> getPurchaseInfo(PurchaseInfoRequest purchaseInfoRequest) {
        ...
        HiAnalyticsClient.reportEntry(this.f29848a, PayNaming.FULL_PURCHASEINFO, 61606301);
        return new PurchaseInfoTask(this.f29848a, purchaseInfoRequest);
    }
    ...
    public Task<PayResult> pay(PayReq payReq) {
        ...
        HiAnalyticsClient.reportEntry(this.f29848a, PayNaming.FULL_PAY, 61606301);
        return new FullSdkPayTask(this.f29848a, payReq);
    }

    @Override // com.huawei.hms.support.api.paytask.PayClient
    public Task<PayResult> productPay(ProductPayRequest productPayRequest) {
        Checker.checkNonNull(productPayRequest);
        HiAnalyticsClient.reportEntry(this.f29848a, PayNaming.FULL_PRODUCTPAY, 61606301);
        return new FullSdkProductPayTask(this.f29848a, productPayRequest);
    }
