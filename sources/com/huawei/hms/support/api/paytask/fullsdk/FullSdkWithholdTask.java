...
public class FullSdkWithholdTask extends BaseFullSdkTask<WithholdRequest> {
    ...
    public Intent getFullSdkIntent() {
        PayRequest payRequestCreateRequestParams;
        if (this.mContext == null || (payRequestCreateRequestParams = createRequestParams()) == null) {
            return null;
        }
        return IapFullAPIFactory.createIapFullAPI(this.mContext).getWithholdIntent(this.mContext, payRequestCreateRequestParams);
    }
}
