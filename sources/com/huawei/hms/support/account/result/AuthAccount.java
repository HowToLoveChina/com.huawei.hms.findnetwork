...
public class AuthAccount extends AbstractAuthAccount {
    ...
    public AuthAccount(String str, String str2, String str3, String str4, String str5, String str6, int i10, int i11, Set<Scope> set, String str7, String str8, String str9, int i12) {
        this.openId = str;
        this.uid = str2;
    ...
    public void parserJson(JSONObject jSONObject) throws JSONException {
        ...
        this.f29755a = jSONObject.optInt(CommonConstant.KEY_ACCOUNT_FLAG, 0);
    }

    @Override // com.huawei.hms.support.feature.result.AbstractAuthAccount
    public void readFromParcel(Parcel parcel) {
        super.readFromParcel(parcel);
        this.f29755a = parcel.readInt();
    }
    ...
    public String toString() {
        return "{uid: " + this.uid + ",displayName: " + this.displayName + ",photoUriString: " + this.photoUriString + ",status: " + this.status + ",gender: " + this.gender + ",serviceCountryCode: " + this.serviceCountryCode + ",countryCode: " + this.countryCode + CommonConstant.KEY_ACCOUNT_FLAG + this.f29755a + '}';
    }

    @Override // com.huawei.hms.support.feature.result.AbstractAuthAccount, android.os.Parcelable
    public void writeToParcel(Parcel parcel, int i10) {
        super.writeToParcel(parcel, i10);
        parcel.writeInt(this.f29755a);
    }
