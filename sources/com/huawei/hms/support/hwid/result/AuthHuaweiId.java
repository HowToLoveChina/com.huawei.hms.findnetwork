...
public class AuthHuaweiId extends AbstractAuthAccount {
    ...
    public AuthHuaweiId(String str, String str2, String str3, String str4, String str5, String str6, int i10, int i11, Set<Scope> set, String str7, String str8, String str9) {
        this.openId = str;
        this.uid = str2;
    ...
    public int getAgeRangeFlag() {
        try {
            ...
            C5602as.m32910b("AuthHuaweiId", "Invalid ageRange NumberFormatException", true);
            return -1;
        }
    }
