...
public class RunnableC5045a implements Runnable {

    /* renamed from: a */
    private Context f23039a;

    public RunnableC5045a(Context context) {
    ...
    public void run() {
        /*
            ...
            r3 = 0
            android.content.Context r4 = r8.f23039a     // Catch: java.lang.Exception -> L27 com.huawei.hms.common.ApiException -> L29
            ...
            android.content.Context r5 = r8.f23039a     // Catch: java.lang.Exception -> L27 com.huawei.hms.common.ApiException -> L29
            ...
            com.huawei.hms.support.log.HMSLog.m36988i(r1, r4)     // Catch: java.lang.Exception -> L27 com.huawei.hms.common.ApiException -> L29
        ...
        L29:
            ...
            com.huawei.hms.support.log.HMSLog.m36986e(r1, r4)     // Catch: java.lang.Exception -> L27
        L33:
            android.content.Context r4 = r8.f23039a     // Catch: java.lang.Exception -> L27 android.content.pm.PackageManager.NameNotFoundException -> L8e
            ...
            android.content.Context r5 = r8.f23039a     // Catch: java.lang.Exception -> L27 android.content.pm.PackageManager.NameNotFoundException -> L8e
            ...
            android.content.Context r8 = r8.f23039a     // Catch: java.lang.Exception -> L27 android.content.pm.PackageManager.NameNotFoundException -> L8e
            boolean r8 = r2.m36445a(r8, r5, r4)     // Catch: java.lang.Exception -> L27 android.content.pm.PackageManager.NameNotFoundException -> L8e
            if (r8 != 0) goto L97
            java.lang.String r8 = "start service failed"
            com.huawei.hms.support.log.HMSLog.m36986e(r1, r8)     // Catch: java.lang.Exception -> L27 android.content.pm.PackageManager.NameNotFoundException -> L8e
            goto L97
        L8a:
            com.huawei.hms.support.log.HMSLog.m36988i(r1, r0)     // Catch: java.lang.Exception -> L27 android.content.pm.PackageManager.NameNotFoundException -> L8e
            goto L97
        L8e:
            com.huawei.hms.support.log.HMSLog.m36988i(r1, r0)     // Catch: java.lang.Exception -> L27
            goto L97
        L92:
            java.lang.String r0 = "Push init failed"
            com.huawei.hms.support.log.HMSLog.m36987e(r1, r0, r8)
        L97:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.huawei.hms.aaid.init.RunnableC5045a.run():void");
    }
}
