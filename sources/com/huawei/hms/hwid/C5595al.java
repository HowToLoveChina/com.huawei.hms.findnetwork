...
/* renamed from: com.huawei.hms.hwid.al */
/* loaded from: classes8.dex */
public class C5595al extends TaskApiCall<C5592ai, Void> {
    public C5595al(String str, String str2, String str3) {
        super(str, str2, str3);
    }
    ...
    public void doExecute(C5592ai c5592ai, ResponseErrorCode responseErrorCode, String str, C8941i<Void> c8941i) {
        ...
        if (m32878a(responseErrorCode, c5590agM32867b.m32868a())) {
            c8941i.m56658d(null);
        } else {
    ...
    public int getApiLevel() {
        C5602as.m32910b("StartConsentTaskApiCall", "startConsent getApiLevel8", true);
        return 8;
    }
    ...
    /* renamed from: a */
    private boolean m32878a(ResponseErrorCode responseErrorCode, Integer num) {
