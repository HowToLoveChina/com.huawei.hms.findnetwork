...
/* renamed from: com.huawei.hms.locationSdk.t1 */
/* loaded from: classes8.dex */
public class C5757t1 extends AbstractC5696b<C5750r0, Void> {
    public C5757t1(String str, String str2, String str3) {
        super(str, str2, str3);
    }
    ...
    public void doExecute(C5750r0 c5750r0, ResponseErrorCode responseErrorCode, String str, C8941i<Void> c8941i) {
        try {
            HMSLocationLog.m36662i("SetMockModeTaskApiCall", ((AbstractC5696b) this).f25484a, "set mock mode doExecute");
            ServiceErrorCodeAdaptor.getInstance().setTaskByServiceErrorCode(c8941i, responseErrorCode, null);
        } catch (Exception unused) {
            HMSLocationLog.m36660e("SetMockModeTaskApiCall", ((AbstractC5696b) this).f25484a, "set mock mode doExecute exception");
