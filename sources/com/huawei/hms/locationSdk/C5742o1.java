...
/* renamed from: com.huawei.hms.locationSdk.o1 */
/* loaded from: classes8.dex */
public class C5742o1 extends AbstractC5696b<C5753s0, Void> {
    public C5742o1(String str, String str2, String str3) {
        super(str, str2, str3);
    }
    ...
    public void doExecute(C5753s0 c5753s0, ResponseErrorCode responseErrorCode, String str, C8941i<Void> c8941i) throws ApiException {
        try {
            HMSLocationLog.m36662i("RequestReportLocationTaskApiCall", ((AbstractC5696b) this).f25484a, "doExecute");
            if (responseErrorCode == null) {
                throw new ApiException(new Status(10000, LocationStatusCode.getStatusCodeString(10000)));
            }
            ServiceErrorCodeAdaptor.getInstance().setTaskByServiceErrorCode(c8941i, responseErrorCode, null);
        } catch (Exception unused) {
            HMSLocationLog.m36660e("RequestReportLocationTaskApiCall", ((AbstractC5696b) this).f25484a, "doExecute exception");
