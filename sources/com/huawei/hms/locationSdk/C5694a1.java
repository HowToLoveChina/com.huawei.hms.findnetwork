...
/* renamed from: com.huawei.hms.locationSdk.a1 */
/* loaded from: classes8.dex */
public class C5694a1 extends AbstractC5696b<C5759u0, Void> {
    public C5694a1(String str, String str2, String str3) {
        super(str, str2, str3);
    }
    ...
    public void doExecute(C5759u0 c5759u0, ResponseErrorCode responseErrorCode, String str, C8941i<Void> c8941i) throws ApiException {
        try {
            HMSLocationLog.m36662i("RemoveGeofencesTaskApiCall", ((AbstractC5696b) this).f25484a, "remove geofences doExecute");
            if (responseErrorCode == null) {
                throw new ApiException(new Status(10000, LocationStatusCode.getStatusCodeString(10000)));
            }
            ServiceErrorCodeAdaptor.getInstance().setTaskByServiceErrorCode(c8941i, responseErrorCode, null);
        } catch (ApiException e10) {
            HMSLocationLog.m36660e("RemoveGeofencesTaskApiCall", ((AbstractC5696b) this).f25484a, "remove geofences doExecute exception:" + e10.getMessage());
            c8941i.m56657c(e10);
        } catch (Exception unused) {
            HMSLocationLog.m36660e("RemoveGeofencesTaskApiCall", ((AbstractC5696b) this).f25484a, "remove geofences doExecute exception");
