...
public class C5716g extends AbstractC5696b<C5756t0, List<HWLocation>> {

    /* renamed from: d */
    private Context f25512d;

    public C5716g(Context context, String str, String str2, String str3, String str4) {
    ...
    public int getApiLevel() {
        int iM59567f = C9538c.m59567f(this.f25512d);
    ...
    public void doExecute(C5756t0 c5756t0, ResponseErrorCode responseErrorCode, String str, C8941i<List<HWLocation>> c8941i) throws ApiException {
        try {
            HMSLocationLog.m36662i("GetFromLocationNameTaskApiCall", ((AbstractC5696b) this).f25484a, "doExecute");
            ...
            HMSLocationLog.m36660e("GetFromLocationNameTaskApiCall", ((AbstractC5696b) this).f25484a, "getFromLocationName doExecute exception:" + e10.getMessage());
            c8941i.m56657c(e10);
        } catch (Exception unused) {
            HMSLocationLog.m36660e("GetFromLocationNameTaskApiCall", ((AbstractC5696b) this).f25484a, "getFromLocationName doExecute exception");
