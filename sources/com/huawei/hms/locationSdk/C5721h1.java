...
/* renamed from: com.huawei.hms.locationSdk.h1 */
/* loaded from: classes8.dex */
public class C5721h1 extends AbstractC5696b<C5747q0, Void> {

    /* renamed from: d */
    private C5714f1 f25519d;

    public C5721h1(String str, String str2, C5714f1 c5714f1) {
        super(str, str2, c5714f1.m33186a());
        this.f25519d = c5714f1;
    }
    ...
    public void doExecute(C5747q0 c5747q0, ResponseErrorCode responseErrorCode, String str, C8941i<Void> c8941i) throws ApiException {
        try {
            HMSLocationLog.m36662i("RequestActivityUpdatesTaskApiCall", ((AbstractC5696b) this).f25484a, "request activity doExecute");
            if (responseErrorCode == null) {
                throw new ApiException(new Status(10000, LocationStatusCode.getStatusCodeString(10000)));
            }
            if (responseErrorCode.getErrorCode() == 0) {
                C5718g1.m33086b().m33192a(this.f25519d);
            }
            ServiceErrorCodeAdaptor.getInstance().setTaskByServiceErrorCode(c8941i, responseErrorCode, null);
        } catch (Exception unused) {
            HMSLocationLog.m36660e("RequestActivityUpdatesTaskApiCall", ((AbstractC5696b) this).f25484a, "request activity doExecute exception");
