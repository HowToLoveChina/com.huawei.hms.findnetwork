...
public class JsonUtil {
    ...
    /* renamed from: a */
    private static void m36612a(JSONObject jSONObject, String str, Object obj, Bundle bundle) {
        if (obj == null) {
            HMSLog.m36989w("JsonUtil", "transfer jsonObject to bundle failed, defaultValue is null.");
            return;
        }
        ...
        if (obj instanceof int[]) {
            ...
            HMSLog.m36989w("JsonUtil", "transfer jsonObject to bundle failed, invalid data type.");
        } else {
    ...
    public static int getInt(JSONObject jSONObject, String str, int i10) {
        ...
        try {
            ...
            HMSLog.m36989w("JsonUtil", "JSONException: get " + str + " error.");
            return i10;
        }
    }
    ...
    public static void transferJsonObjectToBundle(JSONObject jSONObject, Bundle bundle, HashMap<String, Object> map) {
        for (Map.Entry<String, Object> entry : map.entrySet()) {
            m36612a(jSONObject, entry.getKey(), entry.getValue(), bundle);
        }
    }
}
