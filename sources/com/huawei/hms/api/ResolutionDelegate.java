...
public class ResolutionDelegate implements IBridgeActivityDelegate {
    ...
    public void onBridgeActivityCreate(Activity activity) {
        Bundle extras;
        if (activity == null || activity.isFinishing()) {
            HMSLog.m36986e(TAG, "activity is null or finishing");
            return;
        }
        ...
        try {
            ...
            HMSLog.m36986e(TAG, "getExtras exception:" + e10.getMessage());
            extras = null;
        }
        if (extras != null) {
    ...
    public boolean onBridgeActivityResult(int i10, int i11, Intent intent) {
        ...
        if (i11 == -1 && iIsHuaweiMobileServicesAvailable == 0) {
            HMSLog.m36988i(TAG, "Make service available success.");
        } else {
