    ...
    private int syncCall(ApiClient apiClient, IAIDLCallback iAIDLCallback) {
        if (!(apiClient instanceof InnerApiClient)) {
            if (apiClient instanceof AidlApiClient) {
                ...
                try {
                    ...
                    HMSLog.m36986e(TAG, "sync call ex:" + e10);
                }
            }
        ...
        try {
            ...
            if (aidlApiClient2.getService() == null) {
                HMSLog.m36986e(TAG, "HuaweiApiClient is not binded to service yet.");
                return CommonCode.ErrorCode.INTERNAL_ERROR;
            }
            aidlApiClient2.getService().asyncCall(dataBuffer2, iAIDLCallback);
            return 0;
        } catch (Exception e11) {
            HMSLog.m36986e(TAG, "sync call ex:" + e11);
            return CommonCode.ErrorCode.INTERNAL_ERROR;
        }
    }

    @Override // com.huawei.hms.support.api.transport.DatagramTransport
    public final void post(ApiClient apiClient, DatagramTransport.InterfaceC6400a interfaceC6400a) {
        send(apiClient, interfaceC6400a);
    }

    @Override // com.huawei.hms.support.api.transport.DatagramTransport
    public final void send(ApiClient apiClient, DatagramTransport.InterfaceC6400a interfaceC6400a) {
        int iSyncCall = syncCall(apiClient, new IPCCallback(this.mResponseClass, interfaceC6400a));
        if (iSyncCall == 0 || interfaceC6400a == null) {
            return;
        }
        interfaceC6400a.mo36643a(iSyncCall, null);
    }
