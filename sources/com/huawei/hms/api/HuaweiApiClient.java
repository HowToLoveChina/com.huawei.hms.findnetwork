...
public abstract class HuaweiApiClient implements AidlApiClient {
    ...
    public static final class Builder {
        ...
        /* renamed from: b */
        private final List<Scope> f23335b = new ArrayList();

        /* renamed from: c */
        private final List<PermissionInfo> f23336c = new ArrayList();

        /* renamed from: d */
        private final Map<Api<?>, Api.ApiOptions> f23337d = new HashMap();

        /* renamed from: e */
        private OnConnectionFailedListener f23338e;

        /* renamed from: f */
        private ConnectionCallbacks f23339f;

        /* renamed from: g */
        private int f23340g;

        /* renamed from: h */
        private Activity f23341h;
        ...
        /* renamed from: a */
        private void m30572a(Context context) {
            HMSBIInitializer.getInstance(context).initBI();
        }

        public Builder addApi(Api<? extends Api.ApiOptions.NotRequiredOptions> api) throws JSONException {
            this.f23337d.put(api, null);
            if (HuaweiApiAvailability.HMS_API_NAME_GAME.equals(api.getApiName())) {
                HiAnalyticsUtil.getInstance().onEvent(this.f23334a.getApplicationContext(), HiAnalyticsConstant.KeyAndValue.GAME_INIT_KEY, "|" + System.currentTimeMillis());
            }
            return this;
        }
        ...
        public Builder allowLifeCycleManagement(Activity activity, int i10, OnConnectionFailedListener onConnectionFailedListener) {
            ...
            this.f23340g = i10;
            this.f23341h = (Activity) Preconditions.checkNotNull(activity, "activity must not be Null.");
            return this;
        }
        ...
        public HuaweiApiClient build() throws JSONException {
            addApi(new Api<>("Core.API"));
            HuaweiApiClientImpl huaweiApiClientImpl = new HuaweiApiClientImpl(this.f23334a);
            huaweiApiClientImpl.setScopes(this.f23335b);
            huaweiApiClientImpl.setPermissionInfos(this.f23336c);
            huaweiApiClientImpl.setApiMap(this.f23337d);
            huaweiApiClientImpl.setConnectionCallbacks(this.f23339f);
            huaweiApiClientImpl.setConnectionFailedListener(this.f23338e);
            huaweiApiClientImpl.setAutoLifecycleClientId(this.f23340g);
            if (this.f23340g >= 0) {
                m30573a(huaweiApiClientImpl);
            }
        ...
        /* renamed from: a */
        private void m30573a(HuaweiApiClient huaweiApiClient) {
            AutoLifecycleFragment.getInstance(this.f23341h).startAutoMange(this.f23340g, huaweiApiClient);
        }
        ...
        public <O extends Api.ApiOptions.HasOptions> Builder addApiWithScope(Api<O> api, O o10, Scope... scopeArr) {
            ...
            Checker.checkNonNull(scopeArr, "Scopes must not be null");
            this.f23337d.put(api, o10);
            if (api.getOptions() != null) {
                this.f23335b.addAll(api.getOptions().getScopeList(o10));
                this.f23336c.addAll(api.getOptions().getPermissionInfoList(o10));
            }
            this.f23335b.addAll(new ArrayList(Arrays.asList(scopeArr)));
            return this;
        }
