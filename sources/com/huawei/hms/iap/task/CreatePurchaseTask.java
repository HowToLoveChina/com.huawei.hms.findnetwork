...
public class CreatePurchaseTask extends BaseIapFullTask<PurchaseIntentResult, PurchaseIntentReq> {
    ...
    /*  JADX ERROR: ConcurrentModificationException in pass: ConstructorVisitor
        ...
        */
    /* renamed from: a */
    private com.huawei.hms.iapfull.bean.WebProductPayRequest m33005a(
    /*  JADX ERROR: ConcurrentModificationException in pass: ConstructorVisitor
        java.util.ConcurrentModificationException
        	at java.base/java.util.ArrayList$Itr.checkForComodification(Unknown Source)
        	at java.base/java.util.ArrayList$Itr.next(Unknown Source)
    ...
    public void handleRequest(PurchaseIntentReq purchaseIntentReq, IIapFullAPIVer4 iIapFullAPIVer4) {
        Intent pmsPayIntent = iIapFullAPIVer4.getPmsPayIntent(m33005a(purchaseIntentReq));
        this.f25445a = pmsPayIntent;
        ((PurchaseIntentResult) this.mResult).setStatus(pmsPayIntent == null ? new Status(OrderStatusCode.ORDER_STATE_PARAM_ERROR, "param is error") : new Status(0, "success", this.f25445a));
        this.mIsCompleted = true;
    }

    @Override // com.huawei.hms.iap.task.BaseIapFullTask, com.huawei.hmf.tasks.Task
    public boolean isSuccessful() {
        return this.f25445a != null;
    }
