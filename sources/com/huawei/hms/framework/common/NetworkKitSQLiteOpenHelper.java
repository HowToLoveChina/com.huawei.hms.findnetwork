...
public class NetworkKitSQLiteOpenHelper extends SQLiteOpenHelper {
    ...
    public void deleteDbByName(String str) {
        Logger.m32136d(TAG, "close old db from oldDbMaps, dbname = " + str);
    ...
    public boolean deleteDbFileByPath(String str) {
        ...
        Logger.m32141i(TAG, "db is not exists");
        return false;
    }
    ...
    public SQLiteDatabase getDbByName(String str) {
        SQLiteDatabase sQLiteDatabase = this.oldDbMaps.get(str);
        if (sQLiteDatabase != null) {
            Logger.m32136d(TAG, "get old db from oldDbMaps, dbname = " + str);
        ...
        if (!new File(strReplace).exists()) {
            Logger.m32141i(TAG, "old db is not exists");
            return networkKitReadableDatabase;
        }
        ...
        Logger.m32136d(TAG, "create and put old db to oldDbMaps, dbname = " + str);
    ...
    public SQLiteDatabase getNetworkKitReadableDatabase() {
        ...
        try {
            ...
            Logger.m32138e(TAG, "getReadableDatabase db error:" + th2.getMessage());
            readableDatabase = null;
        }
        if (readableDatabase == null) {
            Logger.m32138e(TAG, "getReadableDatabase db is null");
        }
    ...
    public SQLiteDatabase getNetworkKitWritableDatabase() {
        ...
        try {
            ...
            Logger.m32138e(TAG, "getWritableDatabase db error:" + th2.getMessage());
            writableDatabase = null;
        }
        if (writableDatabase == null) {
            Logger.m32138e(TAG, "getWritableDatabase db is null");
        }
