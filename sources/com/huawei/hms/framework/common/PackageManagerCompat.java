...
public class PackageManagerCompat {
    ...
    public static String getAppPackageName(Context context) {
        ...
        try {
            ...
            Logger.m32145w("PackageUtils", "Failed to get Package managers Package Info");
            return "";
        }
    }
    ...
    private static Bundle getBundleFromApp(Context context) throws PackageManager.NameNotFoundException {
        ...
        try {
            ...
            Logger.m32146w("PackageUtils", "NameNotFoundException:", e10);
            return bundle;
        }
    }
    ...
    private static Bundle getBundleFromKit(Context context) {
        ...
        if (context == null) {
            Logger.m32143v("PackageUtils", "the kitContext is null");
            return Bundle.EMPTY;
        }
        if (context.getApplicationInfo() == null) {
            Logger.m32143v("PackageUtils", "the kit applicationInfo is null");
            return Bundle.EMPTY;
        }
        Logger.m32141i("PackageUtils", "kitContext: " + context.getPackageName());
    ...
    public static String getMetaDataFromKit(Context context, String str, String str2) {
        try {
            ...
            Logger.m32143v("PackageUtils", "the kit metaData is runtimeException");
            return str2;
        }
    }
