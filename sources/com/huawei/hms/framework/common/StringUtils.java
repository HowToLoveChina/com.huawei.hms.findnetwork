...
public class StringUtils {
    ...
    public static String byte2Str(byte[] bArr) {
        ...
        try {
            ...
            Logger.m32145w("StringUtils.byte2str error: UnsupportedEncodingException", anonymizeMessage(e10.getMessage()));
            return "";
        }
    }
    ...
    public static String replace(String str, CharSequence charSequence, CharSequence charSequence2) {
        if (isAegisStringLibraryLoaded || checkCompatible(SAFE_STRING_PATH)) {
            try {
                ...
                Logger.m32145w(TAG, "SafeString.substring error");
            }
        }
    ...
    public static byte[] str2Byte(String str) {
        ...
        try {
            ...
            Logger.m32145w("StringUtils.str2Byte error: UnsupportedEncodingException", anonymizeMessage(e10.getMessage()));
            return new byte[0];
        }
    }
    ...
    public static boolean stringToBoolean(String str, boolean z10) {
        ...
        try {
            ...
            Logger.m32145w(TAG, "String to Integer catch NumberFormatException." + anonymizeMessage(e10.getMessage()));
            return z10;
        }
    }
    ...
    public static long stringToLong(String str, long j10) {
        ...
        try {
            ...
            Logger.m32145w(TAG, "String to Long catch NumberFormatException." + anonymizeMessage(e10.getMessage()));
            return j10;
        }
    }
    ...
    public static byte[] getBytes(String str) {
        ...
        try {
            ...
            Logger.m32145w(TAG, "the content has error while it is converted to bytes");
            return bArr;
        }
    }
