...
public class EmuiUtil {
    ...
    public static int getEMUIVersionCode() throws NoSuchFieldException {
        ...
        if (staticFieldObj != null) {
            try {
                ...
                Logger.m32139e(TAG, "getEMUIVersionCode ClassCastException:", e10);
            }
        } else {
            iIntValue = 0;
        }
        Logger.m32136d(TAG, "the emui version code is::" + iIntValue);
        return iIntValue;
    }

    private static void initEmuiType() throws NoSuchFieldException {
        int eMUIVersionCode = getEMUIVersionCode();
        Logger.m32136d(TAG, "getEmuiType emuiVersionCode=" + eMUIVersionCode);
        ...
        if (emuiType == -1) {
            Logger.m32141i(TAG, "emuiType is unkown");
        }
    }

    private static void initHuaweiDevice() throws ClassNotFoundException {
        ...
        Logger.m32141i(TAG, "Get Manufacturer: " + property + ", isHuaweiDevice : " + isHuaweiDevice);
    }
    ...
    public static boolean isUpPVersion() {
        try {
            ...
            Logger.m32136d(TAG, "no such method for com.huawei.android.os.BuildEx.VERSION");
        } catch (Throwable unused2) {
            Logger.m32136d(TAG, "com.huawei.android.os.BuildEx.VERSION has other exception");
        }
        Logger.m32136d(TAG, "com.huawei.android.os.BuildEx : false");
        return false;
    }
}
