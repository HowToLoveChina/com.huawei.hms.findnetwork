...
public class HianalyticsHelper {
    ...
    public class RunnableC54251 implements Runnable {
        final /* synthetic */ Throwable val$e;
        final /* synthetic */ String val$eventId;
        final /* synthetic */ String val$threadName;

        public RunnableC54251(String str, Throwable th2, String str2) {
            str = str;
            th = th2;
            str = str2;
        }
        ...
        public void run() {
            ...
            crashHianalyticsData.put("sdk_version", "8.0.1.309");
            crashHianalyticsData.put(CrashHianalyticsData.CRASH_TYPE, TrackConstants$Events.EXCEPTION);
            crashHianalyticsData.put(CrashHianalyticsData.THREAD_NAME, str);
    ...
    private HianalyticsHelper() {
        ...
        try {
            ...
            Logger.m32141i(TAG, "Hianalytics sdk not found");
        ...
        try {
            ...
            this.bInstallWelink = z10;
        } catch (Exception unused2) {
            this.bInstallWelink = false;
        }
        Logger.m32144v(TAG, "this time the ha %s, mini %s", Boolean.valueOf(this.hasHianalytics), Boolean.valueOf(this.hasHMSBI));
    }
    ...
    private void onNewEvent(Context context, String str, Map map, int i10) {
        ...
        Logger.m32144v(TAG, "data = %s", map);
        try {
            HiAnalyticsUtils.getInstance().onNewEvent(context, str, map, i10);
        } catch (NoSuchMethodError unused) {
            Logger.m32145w(TAG, "may be you need upgrade stats sdk");
        } catch (Throwable unused2) {
            Logger.m32141i(TAG, "the stats has other error,pls check it");
        }
    }

    private void tryHMSBIInit(Context context) {
        if (context == null) {
            Logger.m32141i(TAG, "the appContext hasn't init");
            return;
        }
        try {
            ...
            Logger.m32145w(TAG, "maybe you need add base sdk!");
        } catch (Throwable unused2) {
            Logger.m32145w(TAG, "the hms base has other error!");
        }
    }
    ...
    public void reportException(Throwable th2, String str) {
        if (getInstance().isEnableReportNoSeed(ContextHolder.getAppContext())) {
            InitReport.reportWhenInit(new Runnable() { // from class: com.huawei.hms.framework.common.hianalytics.HianalyticsHelper.1
                ...
                public RunnableC54251(String str2, Throwable th22, String str3) {
                    str = str2;
                    th = th22;
                    str = str3;
                }
    ...
    public void setRate(int i10) {
        ...
        Logger.m32141i(TAG, "bReportable = " + this.bReportable + ", inuser = " + this.bInstallWelink + ", rate = " + i10);
    }
    ...
    private boolean isEnableReport(Context context, boolean z10, boolean z11) {
        ...
        try {
            ...
            Logger.m32145w(TAG, "the setting has illegalStateException");
        } catch (Throwable unused2) {
            Logger.m32145w(TAG, "the setting has other error");
        }
        Logger.m32141i(TAG, "user experience involved needs to be opened");
        return false;
    }
    ...
    public void onEvent(LinkedHashMap<String, String> linkedHashMap, String str, int i10) {
        ...
        Logger.m32144v(TAG, "data = %s", linkedHashMap);
        ...
        if (this.hasHMSBI) {
            ...
            Logger.m32144v(TAG, "the base sdk isn't exsit, and reportType is %s", Integer.valueOf(i10));
            return;
        }
        if (this.hasHianalytics) {
            ...
            if (hiAnalyticsInstance != null) {
                ...
                Logger.m32138e(TAG, "the ha has error,has init but is null!");
            }
        }
    }
