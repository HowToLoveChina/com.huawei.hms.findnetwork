...
import com.huawei.hms.framework.network.grs.p125h.C5456b;
...
public class GrsBaseInfo implements Cloneable {
    ...
    public GrsBaseInfo m85649clone() {
    ...
    public String getGrsParasKey(boolean z10, boolean z11, Context context) {
        ...
        C5438b c5438bM32226a = C5438b.m32226a(context.getPackageName());
        C5462a c5462aM32228a = c5438bM32226a != null ? c5438bM32226a.m32228a() : null;
        String grsReqParamJoint = getGrsReqParamJoint(z10, z11, c5462aM32228a != null ? c5462aM32228a.m32338a() : "", context);
    ...
    public String getGrsReqParamJoint(boolean z10, boolean z11, String str, Context context) {
        ...
        StringBuffer stringBuffer = new StringBuffer();
        if ("1.0".equals(str)) {
            Logger.m32143v(TAG, "1.0 interface has no query param appname");
        } else {
            if (!TextUtils.isEmpty(str)) {
                stringBuffer.append(C5846a3.APP_NAME);
                stringBuffer.append("=");
        ...
        if (!TextUtils.isEmpty(uid)) {
            ...
            stringBuffer.append("=");
            if (z10) {
                strM32323a = C5456b.m32326b(uid);
            } else if (z11) {
                strM32323a = C5456b.m32323a(uid);
            } else {
                stringBuffer.append(uid);
            }
            stringBuffer.append(strM32323a);
        }
    ...
    public String getUrlEncodedStr(String str) {
        try {
            ...
            Logger.m32138e(TAG, "UnsupportedEncodingException, Please check the params!");
            return "";
        }
    }
