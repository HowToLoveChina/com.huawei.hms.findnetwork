...
public class ProxyConverter<F, T> extends Converter<F, T> {
    ...
    public static class ProxyConverterFactory extends Converter.Factory {
        ...
        public com.huawei.hms.network.restclient.Converter<?, RequestBody> requestBodyConverter(Type type, Annotation[] annotationArr, Annotation[] annotationArr2, RestClient restClient) {
            final com.huawei.hms.framework.network.restclient.Converter<?, com.huawei.hms.framework.network.restclient.hwhttp.RequestBody> converterRequestBodyConverter = this.proxy.requestBodyConverter(type, annotationArr, annotationArr2, new com.huawei.hms.framework.network.restclient.RestClient(restClient));
            if (converterRequestBodyConverter != null) {
                return new com.huawei.hms.network.restclient.Converter<Object, RequestBody>() { // from class: com.huawei.hms.framework.network.restclient.proxy.ProxyConverter.ProxyConverterFactory.2
                    ...
                    public RequestBody convert(Object obj) throws IOException {
                        return ProxyRequestBody.requestBody2New((com.huawei.hms.framework.network.restclient.hwhttp.RequestBody) converterRequestBodyConverter.convert(obj));
                    }
                };
            }
            return null;
        ...
        public com.huawei.hms.network.restclient.Converter<ResponseBody, ?> responseBodyConverter(Type type, Annotation[] annotationArr, RestClient restClient) {
            final com.huawei.hms.framework.network.restclient.Converter<com.huawei.hms.framework.network.restclient.hwhttp.ResponseBody, ?> converterResponseBodyConverter = this.proxy.responseBodyConverter(type, annotationArr, new com.huawei.hms.framework.network.restclient.RestClient(restClient));
            if (converterResponseBodyConverter != null) {
                return new com.huawei.hms.network.restclient.Converter<ResponseBody, Object>() { // from class: com.huawei.hms.framework.network.restclient.proxy.ProxyConverter.ProxyConverterFactory.1
                    ...
                    public Object convert(ResponseBody responseBody) throws IOException {
                        return converterResponseBodyConverter.convert(ProxyResponseBody.response2Old(responseBody));
                    }
                };
            }
            return null;
        ...
        public com.huawei.hms.network.restclient.Converter<?, String> stringConverter(Type type, Annotation[] annotationArr, RestClient restClient) {
            final com.huawei.hms.framework.network.restclient.Converter<?, String> converterStringConverter = this.proxy.stringConverter(type, annotationArr, new com.huawei.hms.framework.network.restclient.RestClient(restClient));
            if (converterStringConverter != null) {
                return new com.huawei.hms.network.restclient.Converter<Object, String>() { // from class: com.huawei.hms.framework.network.restclient.proxy.ProxyConverter.ProxyConverterFactory.3
                    ...
                    public String convert(Object obj) throws IOException {
                        return (String) converterStringConverter.convert(obj);
                    }
                };
            }
            return null;
    ...
    public T convert(F f10) throws IOException {
        return this.proxyConverter.convert(f10);
    }
}
