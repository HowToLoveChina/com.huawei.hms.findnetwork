...
public class ProxyWebSocketListener extends WebSocketListener {
    ...
    public void onClosed(WebSocket webSocket, int i10, String str) {
        this.webSocketListener.onClosed(new ProxyWebSocket(webSocket), i10, str);
    }

    @Override // com.huawei.hms.network.httpclient.websocket.WebSocketListener
    public void onClosing(WebSocket webSocket, int i10, String str) {
        this.webSocketListener.onClosing(new ProxyWebSocket(webSocket), i10, str);
    }

    @Override // com.huawei.hms.network.httpclient.websocket.WebSocketListener
    public void onFailure(WebSocket webSocket, Throwable th2, Response<ResponseBody> response) {
        this.webSocketListener.onFailure(new ProxyWebSocket(webSocket), th2, ProxyResponse.response2Old(response));
    }
    ...
    public void onMessage(WebSocket webSocket, byte[] bArr) {
        this.webSocketListener.onMessage(new ProxyWebSocket(webSocket), ByteString.m32417of(bArr));
    }
}
