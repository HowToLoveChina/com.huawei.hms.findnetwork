...
public class RestClient {
    ...
    public RestClient(Builder builder, com.huawei.hms.network.restclient.RestClient restClient) {
    ...
    public static final class Builder {
        ...
        public Builder validateEagerly(boolean z10) {
            this.proxyBuilder.validateEagerly(z10);
            return this;
        }
        ...
        public Builder(IRestClientBuilder iRestClientBuilder) {
