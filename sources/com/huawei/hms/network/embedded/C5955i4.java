...
/* renamed from: com.huawei.hms.network.embedded.i4 */
/* loaded from: classes8.dex */
public class C5955i4 {
    ...
    /* renamed from: a */
    public static final String f27009a = "ErrorCodeUtil";
    ...
    public static int getErrorCodeFromException(Exception exc) {
        try {
            if (exc instanceof C6064q9) {
                return ExceptionCode.SHUTDOWN_EXCEPTION;
            }
        } catch (NoClassDefFoundError | NoSuchMethodError e10) {
            Logger.m32147w("ErrorCodeUtil", "class connectionShutdownException is not found", e10.getClass().getSimpleName());
        }
        if (C5939h1.apiAvailable(4)) {
