...
/* renamed from: com.huawei.hms.findnetwork.sdk.p0 */
/* loaded from: classes8.dex */
public class C5388p0 extends BaseTaskApiCall<HmsClient, BindDeviceRequestBean, FindNetworkResult<String>> {

    /* renamed from: com.huawei.hms.findnetwork.sdk.p0$b */
    public static class b extends TypeToken<FindNetworkResult<ResultResponse>> {
        public b() {
        }
    }

    public C5388p0(BindDeviceRequestBean bindDeviceRequestBean) {
        super("findnetwork.wear_bindDevices", bindDeviceRequestBean);
    }
    ...
    public void handleBusiness(HmsClient hmsClient, ResponseErrorCode responseErrorCode, String str, C8941i<FindNetworkResult<String>> c8941i) {
        ...
        HmsFindSDKLog.m32127i("RequestBindDeviceApiCall", "RequestBindDeviceApiCall handleBusiness, transactionId = " + getTransactionId());
        if (TextUtils.isEmpty(str)) {
            HmsFindSDKLog.m32127i("RequestBindDeviceApiCall", "body null");
            ...
            if (findNetworkResult == null) {
                HmsFindSDKLog.m32127i("RequestBindDeviceApiCall", "body parse error");
                apiException = new ApiException(new Status(-1, "body parse error"));
            } else {
                if (findNetworkResult.getRespCode() == 0) {
                    HmsFindSDKLog.m32127i("RequestBindDeviceApiCall", "request bind device response");
                ...
                HmsFindSDKLog.m32127i("RequestBindDeviceApiCall", "result errorCode = " + findNetworkResult.getRespCode() + ", description = " + findNetworkResult.getDescription());
