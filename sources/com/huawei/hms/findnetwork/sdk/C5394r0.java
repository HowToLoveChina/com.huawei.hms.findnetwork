...
import com.huawei.hms.findnetwork.comm.request.bean.wear.PublicKeyResponse;
...
/* renamed from: com.huawei.hms.findnetwork.sdk.r0 */
/* loaded from: classes8.dex */
public class C5394r0 extends BaseTaskApiCall<HmsClient, FidRequestBean, FindNetworkResult<String>> {

    /* renamed from: com.huawei.hms.findnetwork.sdk.r0$b */
    public static class b extends TypeToken<FindNetworkResult<PublicKeyResponse>> {
        public b() {
        }
    }

    public C5394r0(FidRequestBean fidRequestBean) {
        super("findnetwork.wear_sharingPublicKey", fidRequestBean);
    }
    ...
    public void handleBusiness(HmsClient hmsClient, ResponseErrorCode responseErrorCode, String str, C8941i<FindNetworkResult<String>> c8941i) {
        ...
        HmsFindSDKLog.m32127i("RequestSharingPublicKeyApiCall", "RequestSharingPublicKeyApiCall handleBusiness, transactionId = " + getTransactionId());
        if (TextUtils.isEmpty(str)) {
            HmsFindSDKLog.m32127i("RequestSharingPublicKeyApiCall", "body null");
            ...
            if (findNetworkResult == null) {
                HmsFindSDKLog.m32127i("RequestSharingPublicKeyApiCall", "body parse error");
                apiException = new ApiException(new Status(-1, "body parse error"));
            } else {
                if (findNetworkResult.getRespCode() == 0) {
                    HmsFindSDKLog.m32127i("RequestSharingPublicKeyApiCall", "request public key response");
                    ...
                    if (findNetworkResult.getData() != null) {
                        findNetworkResult2.setData(JsonUtils.object2Json((PublicKeyResponse) findNetworkResult.getData()));
                    }
                    c8941i.m56658d(findNetworkResult2);
                    return;
                }
                HmsFindSDKLog.m32127i("RequestSharingPublicKeyApiCall", "result errorCode = " + findNetworkResult.getRespCode() + ", description = " + findNetworkResult.getDescription());
