...
public class Util {
    ...
    /* renamed from: a */
    private static boolean f30215a = false;

    /* renamed from: b */
    private static boolean f30216b = false;

    /* renamed from: c */
    private static final Object f30217c = new Object();

    /* renamed from: d */
    private static String f30218d;
    ...
    public static String getAppName(Context context, String str) {
        if (context == null) {
            HMSLog.m36986e("Util", "In getAppName, context is null.");
            return "";
        }
        PackageManager packageManager = context.getPackageManager();
        if (packageManager == null) {
            HMSLog.m36986e("Util", "In getAppName, Failed to get 'PackageManager' instance.");
            return "";
        }
        try {
            if (TextUtils.isEmpty(str)) {
            ...
            HMSLog.m36986e("Util", "In getAppName, Failed to get app name.");
            return "";
        }
    }
    ...
    public static int getHmsVersion(Context context) {
        ...
        PackageManager packageManager = context.getPackageManager();
        if (packageManager == null) {
            HMSLog.m36986e("Util", "In getHmsVersion, Failed to get 'PackageManager' instance.");
            return 0;
        }
        try {
            ...
            HMSLog.m36988i("Util", "In getHmsVersion, Failed to read meta data for the HMS VERSION.");
            return 0;
        } catch (AndroidException unused) {
            HMSLog.m36986e("Util", "In getHmsVersion, Failed to read meta data for the HMS VERSION.");
            return 0;
        } catch (RuntimeException e10) {
            HMSLog.m36987e("Util", "In getHmsVersion, Failed to read meta data for the HMS VERSION.", e10);
            return 0;
        }
    }
    ...
    public static String getServiceActionMetadata(Context context) {
        ...
        try {
            ...
            HMSLog.m36986e("Util", "Exception when getServiceActionMetadata. " + e10.getMessage());
            resolveInfoResolveService = null;
        }
        if (resolveInfoResolveService != null) {
            f30218d = PackageConstants.INTERNAL_SERVICES_ACTION;
    ...
    public static boolean isAvailableLibExist(Context context) {
        ...
        synchronized (f30217c) {
            if (!f30215a) {
                PackageManager packageManager = context.getPackageManager();
                if (packageManager == null) {
                    HMSLog.m36986e("Util", "In isAvailableLibExist, Failed to get 'PackageManager' instance.");
                } else {
                    try {
                        ApplicationInfo applicationInfo = packageManager.getPackageInfo(context.getPackageName(), 128).applicationInfo;
                        if (applicationInfo != null && (bundle = applicationInfo.metaData) != null && (obj = bundle.get("availableLoaded")) != null && String.valueOf(obj).equalsIgnoreCase("yes")) {
                            HMSLog.m36988i("Util", "available exist: true");
                        }
                    } catch (AndroidException unused) {
                        HMSLog.m36986e("Util", "In isAvailableLibExist, Failed to read meta data for the availableLoaded.");
                    } catch (RuntimeException e10) {
                        HMSLog.m36987e("Util", "In isAvailableLibExist, Failed to read meta data for the availableLoaded.", e10);
                    }
                    z10 = false;
                    f30216b = z10;
                    f30215a = true;
        ...
        HMSLog.m36988i("Util", "available exist: " + f30216b);
        return f30216b;
    }
    ...
    public static void unBindServiceCatchException(Context context, ServiceConnection serviceConnection) {
        try {
            HMSLog.m36988i("Util", "Trying to unbind service from " + serviceConnection);
            context.unbindService(serviceConnection);
        } catch (Exception e10) {
            HMSLog.m36986e("Util", "On unBindServiceException:" + e10.getMessage());
        }
    }
}
