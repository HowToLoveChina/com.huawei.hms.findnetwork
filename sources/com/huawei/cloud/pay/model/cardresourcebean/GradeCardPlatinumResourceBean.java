...
public class GradeCardPlatinumResourceBean extends GradeCardBaseResourceBean {
    ...
    private void initCommonResource() {
        int i10 = R$color.text_color_user_card_diamond;
        ...
        int i11 = R$color.text_color_package_price_diamond;
        this.packageTitleTextColor = i11;
        this.packagePriceTextColor = i11;
        int i12 = R$color.text_color_package_origin_price_diamond;
    ...
    public GradeCardPlatinumResourceBean(boolean z10) {
        if (z10) {
