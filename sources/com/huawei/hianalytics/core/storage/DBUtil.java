...
public class DBUtil {
    ...
    public static void deleteAll(SQLiteDatabase sQLiteDatabase, String str) throws SQLException {
    ...
    public static void exec(SQLiteDatabase sQLiteDatabase, String str) throws SQLException {
        if (sQLiteDatabase == null || TextUtils.isEmpty(str)) {
            return;
        }
        try {
            ...
            HiLog.m28808e(TAG, e10.getMessage());
        }
    }

    public static void rename(SQLiteDatabase sQLiteDatabase, String str, String str2) throws SQLException {
