...
public class BdsTim {
    ...
    public static final class Builder {
        ...
        /* renamed from: a0 */
        public double f40473a0;

        /* renamed from: a1 */
        public double f40474a1;

        /* renamed from: a2 */
        public double f40475a2;
        public int deltaT;
        public int gnssToId;
        ...
        public BdsTim build() {
            ...
            bdsTim.mA0 = this.f40473a0;
            bdsTim.mWeekSecond = this.weekSecond;
            bdsTim.mA2 = this.f40475a2;
            bdsTim.mGnssToId = this.gnssToId;
            bdsTim.mWeekNumber = this.weekNumber;
            bdsTim.mDeltaT = this.deltaT;
            bdsTim.mA1 = this.f40474a1;
            return bdsTim;
        }

        public Builder but() {
            return aBdsTim().withWeekSecond(this.weekSecond).withWeekNumber(this.weekNumber).withA0(this.f40473a0).withA1(this.f40474a1).withA2(this.f40475a2).withGnssToId(this.gnssToId).withDeltaT(this.deltaT);
        }
