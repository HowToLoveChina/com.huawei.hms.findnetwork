...
public class GlonassTim {
    ...
    public static final class Builder {
        ...
        /* renamed from: a0 */
        public double f40592a0;

        /* renamed from: a1 */
        public double f40593a1;

        /* renamed from: a2 */
        public double f40594a2;
        public int gnssToId;
        ...
        public GlonassTim build() {
            ...
            glonassTim.mA1 = this.f40593a1;
            glonassTim.mA0 = this.f40592a0;
            glonassTim.mA2 = this.f40594a2;
            return glonassTim;
        }

        public Builder but() {
            return aGlonassTim().withWeekSecond(this.weekSecond).withWeekNumber(this.weekNumber).withA0(this.f40592a0).withA1(this.f40593a1).withA2(this.f40594a2).withGnssToId(this.gnssToId);
        }
