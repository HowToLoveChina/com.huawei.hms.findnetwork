...
public class KeyEncryptKey {
    ...
    private void checkC1Version(Context context) throws C14389c {
        if (this.f45393v2 != C8957b.m56703b("Local-C1-Version", -1, context)) {
            throw new C14389c(1020L, "kek V2 with C1 version check fail,  please reapply the credential.");
        }
    }

    private void checkSoVersion() throws C14389c {
        if (this.f45392v1 != ((int) UcsLib.ucsGetSoVersion())) {
            throw new C14389c(1020L, "kek V1 with so version check fail,  please reapply the credential.");
        }
    }

    private void checkVersion(Context context, int i10) throws C14389c, IOException {
    ...
    public static KeyEncryptKey fromString(Context context, String str) throws C14389c, IOException {
        try {
            ...
            throw new C14389c(1020L, "unsupported kek alg");
        } catch (C10626e e10) {
    ...
    private void updateRootKey(Context context) throws C14389c, IOException {
