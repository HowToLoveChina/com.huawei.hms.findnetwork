...
public class Selector {
    ...
    public static InterfaceC9323c0 selectGrsCapability(GrsCapability grsCapability, Context context, String str) throws Exception_C14389c {
        if (grsCapability != null) {
            return new C9342m(grsCapability);
        }
        try {
            if (!TextUtils.isEmpty(str) && (str.length() < 2 || str.length() > 7)) {
                throw new Exception_C14389c(1001L, "serCountry param error");
            }
            ...
            throw new Exception_C14389c(1025L, sbM58651a.toString());
        }
    }

    public static HACapability selectHACapability(HACapability hACapability, InterfaceC9323c0 interfaceC9323c0, EnumC1292b enumC1292b) throws Exception_C14389c {
    ...
    public static NetworkCapability selectNetWorkCapability(NetworkCapability networkCapability, Context context, int i10, int i11) throws Exception_C14389c {
        ...
        try {
            if (i10 < 10000 || i10 > 20000 || i11 < 1 || i11 > 5) {
                throw new Exception_C14389c(1001L, "networkTimeOut or networkRetryTime param error");
            }
