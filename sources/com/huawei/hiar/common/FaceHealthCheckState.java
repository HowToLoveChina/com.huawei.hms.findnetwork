...
public enum FaceHealthCheckState {
    ...
    FaceHealthCheckState(int i10) {
        this.mNativeCode = i10;
    }

    public static FaceHealthCheckState forNumber(int i10) {
        for (FaceHealthCheckState faceHealthCheckState : values()) {
            if (faceHealthCheckState.mNativeCode == i10) {
                return faceHealthCheckState;
            }
        }
