...
public final class DefaultDateTypeAdapter<T extends Date> extends TypeAdapter<T> {
    ...
    public String toString() {
        ...
        if (dateFormat instanceof SimpleDateFormat) {
            return "DefaultDateTypeAdapter(" + ((SimpleDateFormat) dateFormat).toPattern() + C5929g4.f26850l;
        }
        return "DefaultDateTypeAdapter(" + dateFormat.getClass().getSimpleName() + C5929g4.f26850l;
    }
