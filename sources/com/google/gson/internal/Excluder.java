...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    private int modifiers = SyncType.AUTO_SYNC_PHONE_MANAGER;
    ...
    public Excluder disableInnerClassSerialization() {
        Excluder excluderM85642clone = m85642clone();
        excluderM85642clone.serializeInnerClasses = false;
        return excluderM85642clone;
    }
    ...
    public Excluder excludeFieldsWithoutExposeAnnotation() {
        Excluder excluderM85642clone = m85642clone();
        excluderM85642clone.requireExpose = true;
        return excluderM85642clone;
    }
    ...
    public Excluder withExclusionStrategy(ExclusionStrategy exclusionStrategy, boolean z10, boolean z11) {
        ...
        if (z10) {
            ...
            excluderM85642clone.serializationStrategies = arrayList;
            arrayList.add(exclusionStrategy);
        }
        if (z11) {
            ArrayList arrayList2 = new ArrayList(this.deserializationStrategies);
            excluderM85642clone.deserializationStrategies = arrayList2;
    ...
    public Excluder withModifiers(int... iArr) {
        Excluder excluderM85642clone = m85642clone();
        excluderM85642clone.modifiers = 0;
        for (int i10 : iArr) {
            excluderM85642clone.modifiers = i10 | excluderM85642clone.modifiers;
        }
        return excluderM85642clone;
    }
    ...
    public Excluder withVersion(double d10) {
        Excluder excluderM85642clone = m85642clone();
        excluderM85642clone.version = d10;
        return excluderM85642clone;
    }

    /* renamed from: clone, reason: merged with bridge method [inline-methods] */
    public Excluder m85642clone() {
        try {
