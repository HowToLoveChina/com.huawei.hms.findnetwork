...
public final class C1516a {
    ...
    /* renamed from: a */
    public static String m8624a(byte[] bArr, String str) throws UnsupportedEncodingException {
    ...
    /* renamed from: a */
    public static byte[] m8625a(byte[] bArr) {
        return m8626a(bArr, bArr.length);
    }

    /* renamed from: a */
    public static byte[] m8626a(byte[] bArr, int i10) {
        byte b10;
        int i11;
        int i12 = (i10 / 4) * 3;
        if (i12 == 0) {
