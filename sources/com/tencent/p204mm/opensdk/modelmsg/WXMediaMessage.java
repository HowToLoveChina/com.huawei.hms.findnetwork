package com.tencent.p204mm.opensdk.modelmsg;
...
public final class WXMediaMessage {
    ...
    public static class Builder {
        ...
        public static WXMediaMessage fromBundle(Bundle bundle) {
            ...
            if (strPathOldToNew != null && strPathOldToNew.length() > 0) {
                try {
                    ...
                    Log.m56639e(WXMediaMessage.TAG, "get media object from bundle failed: unknown ident " + strPathOldToNew + ", ex = " + e10.getMessage());
                }
            }
            return wXMediaMessage;
        }
        ...
        private static String pathNewToOld(String str) {
            ...
            Log.m56639e(WXMediaMessage.TAG, "pathNewToOld fail, newPath is null");
            return str;
        }

        private static String pathOldToNew(String str) {
            Log.m56640i(WXMediaMessage.TAG, "pathOldToNew, oldPath = ".concat(String.valueOf(str)));
            if (str == null || str.length() == 0) {
                Log.m56639e(WXMediaMessage.TAG, "pathOldToNew fail, oldPath is null");
                return str;
            }
            int iLastIndexOf = str.lastIndexOf(46);
            if (iLastIndexOf == -1) {
                Log.m56639e(WXMediaMessage.TAG, "pathOldToNew fail, invalid pos, oldPath = ".concat(str));
                return str;
            }
    ...
    public final boolean checkArgs() {
        ...
        } else if (C8931d.m56648a(getType()) && ((bArr2 = this.thumbData) == null || bArr2.length > 131072)) {
            str = "checkArgs fail, thumbData should not be null or exceed 128kb";
        } else if (C8931d.m56648a(getType()) || (bArr = this.thumbData) == null || bArr.length <= 65536) {
    ...
    public final void setThumbImage(Bitmap bitmap) throws IOException {
        try {
            ...
            Log.m56639e(TAG, "setThumbImage exception:" + e10.getMessage());
        }
    }
