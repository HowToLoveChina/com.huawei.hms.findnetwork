...
public class WXDynamicVideoMiniProgramObject extends WXMiniProgramObject {
    ...
    @Override // com.tencent.p204mm.opensdk.modelmsg.WXMiniProgramObject, com.tencent.mm.opensdk.modelmsg.WXMediaMessage.IMediaObject
    public boolean checkArgs() {
        String str;
        if (C8931d.m56649b(this.webpageUrl)) {
            str = "webPageUrl is null";
        } else if (C8931d.m56649b(this.userName)) {
