package com.tencent.p204mm.opensdk.modelpay;
...
public class PayReq extends BaseReq {
    ...
    public static class Options {
        ...
        public void fromBundle(Bundle bundle) {
            this.callbackClassName = C8928a.m56644b(bundle, "_wxapi_payoptions_callback_classname");
            this.callbackFlags = C8928a.m56643a(bundle, "_wxapi_payoptions_callback_flags");
        }
    ...
    public void fromBundle(Bundle bundle) {
        ...
        this.appId = C8928a.m56644b(bundle, "_wxapi_payreq_appid");
        this.partnerId = C8928a.m56644b(bundle, "_wxapi_payreq_partnerid");
        this.prepayId = C8928a.m56644b(bundle, "_wxapi_payreq_prepayid");
        this.nonceStr = C8928a.m56644b(bundle, "_wxapi_payreq_noncestr");
        this.timeStamp = C8928a.m56644b(bundle, "_wxapi_payreq_timestamp");
        this.packageValue = C8928a.m56644b(bundle, "_wxapi_payreq_packagevalue");
        this.sign = C8928a.m56644b(bundle, "_wxapi_payreq_sign");
        this.extData = C8928a.m56644b(bundle, "_wxapi_payreq_extdata");
        this.signType = C8928a.m56644b(bundle, "_wxapi_payreq_sign_type");
