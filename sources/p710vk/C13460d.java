...
public class C13460d extends AbstractC4975a<String> {
    ...
    public void prepare(HttpRequestBuilder.a aVar) throws C9721b, IOException {
        ...
        aVar.addHeader("x-hw-trace-id", this.f60634b);
        ...
        aVar.addHeader(FeedbackWebConstants.AUTHORIZATION, new String(C11475a.m68618a((strM80970t + ":" + strM80954p + ":com.huawei.hidisk:" + strM80931j0 + ":" + Uri.encode(this.f60633a)).getBytes("utf-8")), "utf-8"));
