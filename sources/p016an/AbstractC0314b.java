...
public abstract class AbstractC0314b<V> {
    private static final String TAG = "LanguageOperator";
    private SQLiteDatabase mDataBase = C14347e.m85528a();

    public void execSQL(String str) throws C9721b, SQLException {
        SQLiteDatabase sQLiteDatabase = this.mDataBase;
        if (sQLiteDatabase == null) {
            C1461a.m8360w(TAG, "mDataBase is null.");
            return;
        }
        try {
        ...
        if (str != null) {
            try {
                ...
                try {
                    ...
                    SQLiteStatement sQLiteStatementCompileStatement = this.mDataBase.compileStatement(str);
    ...
    public long queryCount(String str) throws C9721b {
        SQLiteDatabase sQLiteDatabase = this.mDataBase;
        if (sQLiteDatabase == null) {
            C1461a.m8360w(TAG, "mDataBase null.");
            throw new C9721b(SNSCode.Status.HW_ACCOUNT_FAILED, "mDataBase null");
        }
        if (str == null) {
