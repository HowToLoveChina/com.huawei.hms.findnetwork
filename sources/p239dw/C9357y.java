...
public class C9357y {
    /* renamed from: a */
    public static EcKeyPair m58721a(Context context) throws C14389c, KeyStoreException {
        try {
            ...
            if (ecKeyPairGenerateEcKeyPair == null) {
                throw new C14389c(1022L, "key is null");
            }
            ...
            byte[] bArrM68822b = C11532e.m68822b(EnumC14380a.AES_GCM.m85606b());
    ...
    /* renamed from: c */
    public static EcKeyPair m58723c(Context context) throws C14389c {
        ...
        if (TextUtils.isEmpty(strM56705d)) {
            throw new C14389c(1022L, "no cache key");
        }
        String[] strArrSplit = strM56705d.split(":");
        if (strArrSplit.length != 3) {
            throw new C14389c(1022L, "invalid cache key");
        }
        if (C9354v.f46761d == null) {
            C9354v.f46761d = new C9311a();
        }
