...
public class C9324d {
    ...
    /* renamed from: a */
    public String m58661a() throws Exception_C14389c {
        if (TextUtils.isEmpty(this.f46698a) || TextUtils.isEmpty(this.f46699b) || TextUtils.isEmpty(this.f46700c)) {
            throw new Exception_C14389c(2001L, "get  AppAuthtication JWS is empty...");
        }
        return m58662b() + "." + this.f46700c;
    }

    /* renamed from: b */
    public String m58662b() throws Exception_C14389c {
        if (TextUtils.isEmpty(this.f46698a) || TextUtils.isEmpty(this.f46699b)) {
            throw new Exception_C14389c(2001L, "Get AppAuthtication signStr error");
        }
