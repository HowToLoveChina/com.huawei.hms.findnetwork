...
public class C9322c {
    /* renamed from: a */
    public static boolean m58657a(Certificate[] certificateArr) throws C14389c {
        String strSubstring;
        if (certificateArr == null || certificateArr.length <= 0) {
            throw new C14389c(1022L, "isRootCertSupport params certificates is null!");
        }
        Certificate certificate = certificateArr[certificateArr.length - 1];
        if (certificate == null) {
            throw new C14389c(1022L, "params certificate is null!");
        }
        try {
            int i10 = 0;
            ...
            throw new C14389c(1022L, sbM58651a.toString());
        }
    }
}
