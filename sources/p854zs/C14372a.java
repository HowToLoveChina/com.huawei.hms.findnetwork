...
public final class C14372a {
    /* renamed from: a */
    public static GlonassNav[] m85569a(JSONArray jSONArray) {
    ...
    /* renamed from: b */
    public static GpsNav[] m85570b(JSONArray jSONArray) {
        ArrayList arrayList = new ArrayList();
        int i10 = 0;
        int i11 = 0;
    ...
    /* renamed from: c */
    public static GalileoNav[] m85571c(JSONArray jSONArray) {
        ArrayList arrayList = new ArrayList();
        for (int i10 = 0; i10 < jSONArray.length(); i10++) {
            JSONObject jSONObjectOptJSONObject = jSONArray.optJSONObject(i10);
    ...
    /* renamed from: d */
    public static BdsNav[] m85572d(JSONArray jSONArray) {
        ArrayList arrayList = new ArrayList();
        int i10 = 0;
        int i11 = 0;
        while (i11 < jSONArray.length()) {
