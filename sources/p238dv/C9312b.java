...
public class C9312b extends AbstractC9314d {
    ...
    public C9312b(enumKeyStore enumKeyStore) {
        super(enumKeyStore);
    }
    ...
    public void mo58622c(C9313c c9313c) throws Exception_C10624c, NoSuchAlgorithmException, NoSuchProviderException, InvalidAlgorithmParameterException {
        try {
            ...
            if (keyPairGenerator.generateKeyPair() != null) {
                ...
                throw new Exception_C10624c("generate ec key pair failed with bad key");
            }
        } catch (InvalidAlgorithmParameterException | NoSuchAlgorithmException | NoSuchProviderException | ProviderException e10) {
            throw new Exception_C10624c("generate ec key pair failed, " + e10.getMessage());
        }
    }
