...
public class C12962e0 extends AbstractC12988v<BaseResponse> {
    ...
    public BaseResponse mo77904k(Class<BaseResponse> cls) {
        ...
        try {
            try {
                ...
                upsertStatusRequest.setStatus("false");
                this.f61708b.m83560q().upsert(upsertStatusRequest).execute();
            } catch (IOException e10) {
                C1120a.m6676e("ResumeExecutor", "ResumeExecutor runTask IOException: " + e10.toString());
                ...
                C1120a.m6676e("ResumeExecutor", "ResumeExecutor runTask Exception: " + e11.toString());
