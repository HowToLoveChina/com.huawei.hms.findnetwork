...
public class C12708e extends AbstractC12706c {
    ...
    public int onBackup(Context context, AbstractC0048c abstractC0048c, Handler.Callback callback, Object obj, String str) {
        C2111d.m12653i("BackupNormalFileImp", "onBackup begin");
        String strM65400j = C10713c.m65400j(BackupObject.getExecuteParameter(), "key_other_file_name");
    ...
    public int onRestore(Context context, AbstractC0048c abstractC0048c, Handler.Callback callback, Object obj, String str) {
        String strM196n;
        C2111d.m12653i("BackupNormalFileImp", "onRestore begin");
        int i10 = 1;
        ...
        if (iM65395e == 2 || iM65395e == 4) {
            ...
            strM196n = C10713c.m65400j(BackupObject.getExecuteParameter(), "key_other_file_name");
        }
        ...
        c12718o.m76537m(511, iM65394d, i10, false);
