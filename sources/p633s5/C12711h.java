...
public class C12711h extends AbstractC12706c {
    ...
    public int onBackup(Context context, AbstractC0048c abstractC0048c, Handler.Callback callback, Object obj, String str) {
        C2111d.m12653i("BackupPhotoSdImp", "onBackup");
        int iM65395e = C10713c.m65395e(BackupObject.getExecuteParameter(), CloneService.KEY_ACTION_FLAG, 1);
        if (iM65395e == 3 || iM65395e == 5) {
            return 0;
        }
        C12707d c12707d = new C12707d(context, abstractC0048c, callback, obj, C10713c.m65400j(BackupObject.getExecuteParameter(), "key_pic_sd_file_name"));
        c12707d.m76517a(512, 3);
    ...
    */
    public int onRestore(android.content.Context r12, p006a5.AbstractC0048c r13, android.os.Handler.Callback r14, java.lang.Object r15, java.lang.String r16) {
        ...
        L1c:
            android.os.Bundle r0 = com.huawei.android.backup.service.logic.BackupObject.getExecuteParameter()
            java.lang.String r5 = "key_pic_sd_file_name"
        ...
        L3d:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p633s5.C12711h.onRestore(android.content.Context, a5.c, android.os.Handler$Callback, java.lang.Object, java.lang.String):int");
    }
}
