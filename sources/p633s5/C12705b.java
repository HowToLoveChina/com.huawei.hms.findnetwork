...
public class C12705b extends AbstractC12706c {
    ...
    public int onBackup(Context context, AbstractC0048c abstractC0048c, Handler.Callback callback, Object obj, String str) {
        C2111d.m12653i("BackupDocumentSdImp", "onBackup");
        C12707d c12707d = new C12707d(context, abstractC0048c, callback, obj, C10713c.m65400j(BackupObject.getExecuteParameter(), "key_doc_sd_file_name"));
        c12707d.m76517a(515, 3);
    ...
    public int onRestore(Context context, AbstractC0048c abstractC0048c, Handler.Callback callback, Object obj, String str) {
        String strM196n;
        C2111d.m12653i("BackupDocumentSdImp", "onRestore");
        int i10 = 1;
        ...
        if (iM65395e == 2 || iM65395e == 4) {
            ...
            strM196n = C10713c.m65400j(BackupObject.getExecuteParameter(), "key_doc_sd_file_name");
        }
        int i11 = C13345n.m80074m(context, 3) ? 3 : 2;
        C12718o c12718o = new C12718o(context, callback, obj, str, strM196n);
        c12718o.m76537m(515, i11, i10, false);
