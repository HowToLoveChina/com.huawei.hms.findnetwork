...
public class C12710g extends AbstractC12706c {
    ...
    public int onBackup(Context context, AbstractC0048c abstractC0048c, Handler.Callback callback, Object obj, String str) {
        C2111d.m12653i("BackupPhotoImp", "onBackup");
        int iM65395e = C10713c.m65395e(BackupObject.getExecuteParameter(), CloneService.KEY_ACTION_FLAG, 1);
        if (iM65395e == 3 || iM65395e == 5) {
            return 0;
        }
        String strM65400j = C10713c.m65400j(BackupObject.getExecuteParameter(), "key_pic_file_name");
    ...
    public int onRestore(Context context, AbstractC0048c abstractC0048c, Handler.Callback callback, Object obj, String str) {
        int i10;
        String str2;
        C2111d.m12653i("BackupPhotoImp", "onRestore");
        int iM65395e = C10713c.m65395e(BackupObject.getExecuteParameter(), CloneService.KEY_ACTION_FLAG, 1);
        String strM196n = "";
        if (iM65395e == 2 || iM65395e == 4) {
            ...
            if (strM65400j != null) {
                ...
                c12718o.m76537m(503, iM65394d, i10, true);
        ...
        c12718o2.m76537m(503, iM65394d2, i10, true);
