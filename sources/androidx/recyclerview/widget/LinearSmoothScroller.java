...
public class LinearSmoothScroller extends RecyclerView.AbstractC0855y {
    ...
    @Override // androidx.recyclerview.widget.RecyclerView.AbstractC0855y
    public void onSeekTargetStep(int i10, int i11, RecyclerView.C0856z c0856z, RecyclerView.AbstractC0855y.a aVar) {
        if (getChildCount() == 0) {
            stop();
            return;
        }
    ...
    public void onTargetFound(View view, RecyclerView.C0856z c0856z, RecyclerView.AbstractC0855y.a aVar) {
        ...
        if (iCalculateTimeForDeceleration > 0) {
            aVar.m5302d(-iCalculateDxToMakeVisible, -iCalculateDyToMakeVisible, iCalculateTimeForDeceleration, this.mDecelerateInterpolator);
        }
    }

    public void updateActionForInterimTarget(RecyclerView.AbstractC0855y.a aVar) {
        ...
        aVar.m5302d((int) (this.mInterimTargetDx * TARGET_SEEK_EXTRA_SCROLL_RATIO), (int) (this.mInterimTargetDy * TARGET_SEEK_EXTRA_SCROLL_RATIO), (int) (calculateTimeForScrolling(10000) * TARGET_SEEK_EXTRA_SCROLL_RATIO), this.mLinearInterpolator);
    }
}
