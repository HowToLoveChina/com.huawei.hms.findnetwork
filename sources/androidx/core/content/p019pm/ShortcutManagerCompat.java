...
import androidx.core.content.p019pm.ShortcutInfoCompat;
import androidx.core.content.p019pm.ShortcutInfoCompatSaver;
...
public class ShortcutManagerCompat {
    ...
    public class C06331 extends BroadcastReceiver {
        final /* synthetic */ IntentSender val$callback;

        public C06331(IntentSender intentSender) {
    ...
    public static boolean convertUriIconToBitmapIcon(Context context, ShortcutInfoCompat shortcutInfoCompat) {
        ...
        if (inputStreamM3917q == null || (bitmapDecodeStream = BitmapFactory.decodeStream(inputStreamM3917q)) == null) {
            return false;
        }
        shortcutInfoCompat.mIcon = i10 == 6 ? IconCompat.m3902e(bitmapDecodeStream) : IconCompat.m3905h(bitmapDecodeStream);
        return true;
    }
    ...
    public static boolean pushDynamicShortcut(Context context, ShortcutInfoCompat shortcutInfoCompat) {
        C9373h.m58745f(context);
        C9373h.m58745f(shortcutInfoCompat);
