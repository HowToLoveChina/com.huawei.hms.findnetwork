...
final class ViewingConditions {
    ...
    /* renamed from: mC */
    private final float f3424mC;
    private final float mFl;
    private final float mFlRoot;

    /* renamed from: mN */
    private final float f3425mN;
    ...
    public static ViewingConditions make(float[] fArr, float f10, float f11, float f12, boolean z10) {
        ...
        return new ViewingConditions(fYFromLStar, ((fArr8[0] * 2.0f) + fArr8[1] + (fArr8[2] * 0.05f)) * fPow, fPow, fPow, fLerp, f21, fArr6, fCbrt, (float) Math.pow(fCbrt, 0.25d), fSqrt);
    }
