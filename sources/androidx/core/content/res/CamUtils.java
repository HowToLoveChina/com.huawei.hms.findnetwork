...
final class CamUtils {
    ...
    public static int intFromLStar(float f10) {
        ...
        return C13503b.m81218b(f14 * fArr[0], f12 * fArr[1], f13 * fArr[2]);
    }
    ...
    public static float[] xyzFromInt(int i10) {
        ...
        float[] fArr2 = fArr[0];
        float f10 = (fArr2[0] * fLinearized) + (fArr2[1] * fLinearized2) + (fArr2[2] * fLinearized3);
        float[] fArr3 = fArr[1];
        float f11 = (fArr3[0] * fLinearized) + (fArr3[1] * fLinearized2) + (fArr3[2] * fLinearized3);
        float[] fArr4 = fArr[2];
        return new float[]{f10, f11, (fLinearized * fArr4[0]) + (fLinearized2 * fArr4[1]) + (fLinearized3 * fArr4[2])};
    }
