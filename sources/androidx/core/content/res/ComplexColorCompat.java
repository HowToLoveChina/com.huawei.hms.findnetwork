...
public final class ComplexColorCompat {
    ...
    private ComplexColorCompat(Shader shader, ColorStateList colorStateList, int i10) {
        this.mShader = shader;
        this.mColorStateList = colorStateList;
        this.mColor = i10;
    }

    private static ComplexColorCompat createFromXml(Resources resources, int i10, Resources.Theme theme) throws XmlPullParserException, Resources.NotFoundException, IOException {
        int next;
    ...
    public static ComplexColorCompat inflate(Resources resources, int i10, Resources.Theme theme) {
        try {
    ...
    public static ComplexColorCompat from(int i10) {
