...
public final class PermissionChecker {
    ...
    public static int checkPermission(Context context, String str, int i10, int i11, String str2) {
        ...
        String strM79761c = C13300b.m79761c(str);
        if (strM79761c == null) {
            return 0;
        }
        if (str2 == null) {
        ...
        return ((Process.myUid() != i11 || !C9368c.m58729a(context.getPackageName(), str2)) ? C13300b.m79760b(context, strM79761c, str2) : C13300b.m79759a(context, i11, strM79761c, str2)) == 0 ? 0 : -2;
    }
