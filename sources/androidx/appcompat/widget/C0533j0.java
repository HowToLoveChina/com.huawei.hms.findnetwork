...
public class C0533j0 extends C0549x {

    /* renamed from: c */
    public static boolean f2363c = false;

    /* renamed from: b */
    public final WeakReference<Context> f2364b;

    public C0533j0(Context context, Resources resources) {
        super(resources);
        this.f2364b = new WeakReference<>(context);
    }
    ...
    /* renamed from: c */
    public static boolean m3048c() {
        m3047b();
        return false;
    }

    @Override // androidx.appcompat.widget.C0549x, android.content.res.Resources
    ...
    public Drawable getDrawable(int i10) throws Resources.NotFoundException {
        Context context = this.f2364b.get();
        return context != null ? C0548w.m3156g().m3173s(context, this, i10) : m3181a(i10);
    }
