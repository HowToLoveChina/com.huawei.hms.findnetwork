...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    /* renamed from: B */
    public static int m2619B(View view) {
        int iM59834B = C9603h0.m59834B(view);
        if (iM59834B > 0) {
            return iM59834B;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m2619B(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    /* renamed from: A */
    public final void m2620A(View view, int i10, int i11, int i12, int i13) {
        view.layout(i10, i11, i12 + i10, i13 + i11);
    }

    /* renamed from: C */
    public final boolean m2621C(int i10, int i11) {
        ...
        if (view2 != null) {
            view2.measure(i10, 0);
            iM2619B = m2619B(view2);
            measuredHeight = view2.getMeasuredHeight() - iM2619B;
            paddingTop += iM2619B;
        ...
        if (view2 != null) {
            int i14 = paddingTop - iM2619B;
            int iMin = Math.min(i13, measuredHeight);
            if (iMin > 0) {
                i13 -= iMin;
                iM2619B += iMin;
            }
            view2.measure(i10, View.MeasureSpec.makeMeasureSpec(iM2619B, 1073741824));
        ...
        m2622l(childCount, i11);
        return true;
    }

    /* renamed from: l */
    public final void m2622l(int i10, int i11) {
    ...
    */
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L5a:
            ...
            r2 = r11
        L7e:
            int r3 = p273f0.C9603h0.m59832A(r17)
            int r2 = p273f0.C9614n.m60102b(r2, r3)
            r2 = r2 & 7
            r3 = 1
            if (r2 == r3) goto L98
            r3 = 5
